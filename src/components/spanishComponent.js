    ...
    <form>
      <section className="section raise-top">
        <div className="section-content">
          ...
          <p className="topBottom">You may use a <a href="https://www.spanishdict.com/" rel="noreferrer" target="_blank">translator</a> to
          ...
          <ol className="vocab">
            ...
            <li>Write 5 new Spanish phrases you learned from the video. Write these phrases in Spanish and then translate to English. For
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video. Write these phrases in Spanish and then translate to English.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Write 10 words you learned. Write them in Spanish and and English. For example: <i>por favor =
              please</i></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <h4>QUESTIONS</h4>
          <ol className="vocab">
            <li>Write the body parts you learned in Spanish. Write them in Spanish and and English.</li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What goes wrong at the concert? What did they find in the theatre? Answer in a complete sentence in
              Spanish.
            </li>
            <li>Describe in Spanish what happens in this episode of "Learn Spanish for Beginners."</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li>Describe in Spanish what happens in this episode of "Learn Spanish for Beginners."</li>
            <li>What are the different flavors of ice cream? Write them in Spanish.</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <textarea className="textArea" onChange={onChangespanishListener23} value={spanishEssay23}/>
          ...
          <ol className="vocab">
            <li>Write as many of the words from the video as you can in Spanish. You may need to watch the video more
              than once.
            </li>
          ...
          <ol className="vocab">
            ...
            <li>What are the most common mistakes made in speaking Spanish?</li>
            <li></li>
            <li></li>
            <li></li>
            <li></li>
          ...
          <ol className="vocab">
            <li></li>
            <li></li>
            <li>How would you write, it is 7 o'clock?</li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Give an example of Spanish sentence that uses the past tense.</li>
          ...
          <ol className="vocab">
            ...
            <li>List 5 items you should have to prepare for a natural disaster. Write your list in Spanish.</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li>Write 5 new phraes you learned from the Easy Spanish video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What was this episode of Extra Spanish about? Write your response in Spanish.  You may use a <a
              href="https://www.spanishdict.com/" rel="noreferrer" target="_blank"> translation app </a> to help you if
              you need it.</li>
          ...
          <ol className="vocab">
            ...
            <li>What was this episode of Extra Spanish about? Write your response in Spanish.  You may use a <a
              href="https://www.spanishdict.com/" rel="noreferrer" target="_blank"> translation app </a> to help you if
              you need it.</li>            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What is your favorite season? Answer in Spanish in complete sentences.</li>
            <li>Do you like winter? Explain why. Answer in Spanish in complete sentences.</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
     ...
     <Video videoUrl="https://www.youtube.com/embed/pe5p-mUFIZM?list=PLkjyx6Il3YUZlnm7Y1CzL3nwh6JJcxEfW"/>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Write 5 ways t say "No" in Spanish.</li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What would you do with $200. Deacribe this in Spanish.</li>
            <li></li>
            <li>Write 5 new phrases you learned in Easy Spanish.</li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What is the Spanish infinite? Give 2 examples and translate to English.</li>
            <li>Describe yourself in 4-5 sentences using Spanish.</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Write 10 phrases that use the word 'Que' that you learned in the video. Translate what each phrase means.</li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What was the happiest moment of your life?  Describe this in Spanish. </li>
            <li>Write 5 new phrases you learned from Easy Spanish.</li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>What would be your ideal holiday? In 4-5 sentences write this in Spanish.</li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <p className="topBottom">Watch the video, answer the questions below and complete a full lesson on <a
            href="https://www.duolingo.com/" rel="noreferrer" target="_blank">Duolingo.</a></p>
          <Video videoUrl="https://www.youtube.com/embed/Ua0_D7GxNuc?list=PLkjyx6Il3YUZlnm7Y1CzL3nwh6JJcxEfW"/> <h4>QUESTIONS</h4>
          <ol className="vocab">
            <li></li>
            <li></li>
            <li></li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Imagine you take a trip to Mexico City.  Which places would you visit?  Write your response in Spanish.</li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li>What happens in this episode of Extra Spanish? Write your answer in Spanish.
              You may use a <a href="https://www.spanishdict.com/" rel="noreferrer" target="_blank">translator</a> to
              help you if you need it.</li>            <li></li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Do you believe in any superstitions?  If so, explain what they are and if not explain why you don't believe in them in Spanish</li>
          ...
          <ol className="vocab">
            ...
            <li>What happens in this episode of Extra Spanish? Write your answer in Spanish.
              You may use a <a href="https://www.spanishdict.com/" rel="noreferrer" target="_blank">translator</a> to
              help you if you need it.</li>            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          </ol>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>Write 5 statements in Spanish using the verb "to go". Use a different pronoun for each sentence. (Yo, Tu, Usted, Nosotros, Ustedes) </li>
          ...
          <ol className="vocab">
            <li>What happens in this episode of Extra Spanish? Write your answer in Spanish.</li>
            <li>This was the final episode. How did you like the series? Explain in Spanish why you did or didn't like it.</li>
            <li></li>
            <li></li>
            <li></li>
            <li></li>
          ...
          <ol className="vocab">
            ...
            <li></li>
            <li></li>
            <li>The narrator in the video talks about his culture shock after arriving in Spain. Of the five things he discussed,
            which did you find the most interesting and why? Write your response in Spanish.</li>
            <li></li>
            <li></li>
            <li>Write 5 new Spanish phrases you learned from the video.</li>
            <li>Write the name of the lesson you completed on Duolingo.</li>
          ...
          <ol className="vocab">
            ...
            <li>In the video, the guest being interviewed is from Ecuador.  What was something she talk about that
              you found interesting? Describe this in Spanish.</li>
