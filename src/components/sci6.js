      ...
      <section className="section raise-top">
        <div className="section-content">
          ...
          <textarea className="textArea"
                    placeholder="Write your responses here. Your work will automatically be saved to your Local Storage. If you clear your cookies, your answers will be erased. Be sure to save your work in another location! You can a) right click to 'Select All', right click to 'Print' and then save as a PDF on your computer, b) click to 'Share' and email to your parent/teacher, c) copy/paste into Google docs or onto your device."
