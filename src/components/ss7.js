    ...
    <form>
      ...
      <div className="section raise-top">
        <div className="section-content">
          <h1 className="section-title">World History</h1>
          <span className="days">LESSON 1</span>
          <p><a href={require("../resources/social-studies/ss-pdfs7th/1_TheScientificRevolution.pdf")} rel="noreferrer"
                target="_blank">Click here to read about <i>The Scientific Revolution </i></a></p>
          <p class="margin-para"> After you complete the reading, answer the following questions:<br/>
            ...
            giants." Could this be said of most scientific accomplishments? Explain. <br/>
            <span className='smallerFont'> &nbsp;  &nbsp; Write your responses below.  They will automatically be saved to your local storage. <br/>
              &nbsp;  &nbsp;  IMPORTANT: If you clear your cookies, your work will be erased.  <br/>
              &nbsp;  &nbsp;  Back up your work or copy/paste it into an email to your teacher or parent.</span></p>
          ...
          <p>Answer the following questions: <br/>
            1. Why does Copernicus need to be reassured that his work is for the "well being of the Church"?<br/>
            2. Why does the work and discoveries of Galileo make people nervous?<br/>
            3. Why does it make sense that the Scientific Revolution would follow the Renaissance and continue alongside
            the Protestant Reformation? <br/>
            4. Why might it have been necessary to confirm the results of an experiment 30 and 100 times during the time
          ...
          <p><a href={require("../resources/social-studies/ss-pdfs7th/2_TheEnlightenmentInEurope.pdf")} rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            3. Who were the philosophes and what did they advocate? <br/>
          ...
          <p><a href={require("../resources/social-studies/ss-pdfs7th/3_TheEnlightenmentSpreads.pdf")} rel="noreferrer"
                target="_blank">Click here to
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            3. What new form of literature emerged during the 18th century and what were its main characteristics? <br/>
          ...
          <p>Watch the video below: <b> The Enlightenment </b>by Crash Course. Then, complete the essay assignment that
            follows.</p>
          ...
          <p>Take a few minutes to think about the essay topic and then create an outline for <i> which impact of the
            Enlightenment you think is most important.</i> Click here for an OUTLINE that can help you get started. You
            may need to do some research online. This step will save you from having to rewrite your essay after you
            start. <br/>
            &nbsp;  &#8226;  Introduction paragraph: <br/>
            &nbsp;  &#8226;  Write a hook to grab your reader’s attention. <br/>
            &nbsp;  &#8226;  Have a clear thesis statement. This statement will convey the points or arguments you are
            going to make. It is a road map for your essay and should answer the question, "What is this paper
            about? <br/>"
            &nbsp;  &#8226;  The final sentence for this paragraph should smoothly transition to the next
            paragraph. <br/>
            &nbsp;  &#8226;  Paragraph 1<br/>
            &nbsp;  &#8226;  This paragraph should make your strongest point. You should include examples, explanations
            and support for your claims and ideas. Be sure to smoothly transition to the next paragraph. It should tie
            in to the next point you will make. 3-5 sentences. <br/>
            &nbsp;  &#8226;  Paragraph 2<br/>&nbsp;  &#8226;  Introduce your next point. Again, use examples to support
            your statements and transition to the next paragraph. 3-5 sentences. <br/>
            &nbsp;  &#8226;  Paragraph 3 <br/>
            &nbsp;  &#8226;  This should be your second strongest point. It should be different from the other
            paragraphs but also use examples and explanations for claims you make. 3-5 sentences. <br/>
            &nbsp;  &#8226;  Conclusion <br/>
            &nbsp;  &#8226;  Restate your thesis in a different way. Summarize your essay concisely. End with a
            thoughtful conclusion. 3-5 sentences. <br/>
          </p>
          <textarea className="textArea" onChange={onChangeSS7Listener6} value={SS7Essay6}/>

          <span className="days">LESSON 7</span>
          <p>Watch the video below: <b> Tea, Taxes, and The American Revolution </b>by Crash Course</p>
          <Video videoUrl="https://www.youtube.com/embed/HlUiSBXQHCw"/>
          <p>Answer the following questions: <br/>
            1. Explain the significance of the person, place or thing. <br/>
            <ol className="ssList">
              <li> Stamp Act</li>
              <li> Committees of Correspondence</li>
              <li> Enlightenment</li>
              <li> Declaration of Independence</li>
            </ol>
            Answer the questions in one complete sentence and use the vocabulary above when possible. <br/>
            2. Why did colonists in North America have an issue with being taxed by the British government? <br/>
            3. How did the English crown benefit from the import of consumer goods to American colonies? <br/>
            4. What elements of American government existed prior to the Declaration of Independence? <br/>
            5. Why might Africans in North America have been better off had the British won the Revolutionary War? <br/>
            6. According to John Green, what was revolutionary about the American Revolution? <br/>
          </p>
          <textarea className="textArea" onChange={onChangeSS7Listener7} value={SS7Essay7}/>

          <span className="days">LESSON 8</span>
          <p><a href={require("../resources/social-studies/ss-pdfs7th/4_TheAmericanRevolution.pdf")} rel="noreferrer"
                target="_blank">Click here to
          ...
          6. What might have happened if the men in Congress who opposed slavery did not go along with the decision to
          ...
          <p>Watch the video below: <b> Taxes, Tea, and The American </b>by Crash Course</p>
          ...
          8. What was the most effective way to protest British law? <br/> How did they enforce the protest? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            similar? <br/> How were they different? <br/>
          </p>
          ...
          <p>Answer the following questions: <br/>
            ...
            4. What was the main point of Enlightenment according to Immanuel Kant? <br/> What was the impact on the
            monarchy of this idea? <br/>
            5. What are the three estates and who was in each estate? <br/>
            6. Why did the Third Estate decide to form a National Assembly? <br/> What was the king’s reaction to
            this? <br/>
            7. What was the Tennis Court Oath? <br/> Why is it called that? <br/>
            ...
            Revolution? <br/> What was the King Louis XVI’s response? <br/>
          ...
          <p>Answer the following questions: <br/>
            1. Describe Napoleon before he joined the military and became an emperor. What languages did he speak? Was
          ...
          <p><a href={require("../resources/social-studies/ss-pdfs7th/7_NapoleonForgesanEmpire.pdf")} rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            6. Napoleon had no choice but to invade Russia. Do you agree with this statement? Why or why not? <br/></p>
          <textarea className="textArea" onChange={onChangeSS7Listener17} value={SS7Essay17}/>

          <span className="days">LESSON 18</span>
          <p> If you had lived in France during Napoleon’s rein of power, would you have supported him? <br/> In a 5
            Paragraph Essay, explain why or why not. In addition to using the reading and videos, you may do online
            research to find examples and support. <br/>
            Click here for a 5 Paragraph Essay OUTLINE if you need help in getting started. <br/></p>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/9_TheCongressofVienna.pdf")} rel="noreferrer"
                     target="_blank"> The
          ...
          <p>Write a brief summary of the video. Discuss the main points and include what you considered to be the
            most interesting aspects. You may need to watch the video twice and take notes while watching. 5-6
            sentences. <br/></p>
          <textarea className="textArea" onChange={onChangeSS7Listener21} value={SS7Essay21}/>

          <span className="days">LESSON 22</span>
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/10_LatinAmericanPeoplesWinIndependence.pdf")}
                     rel="noreferrer"
          ...
          1. What are the three institutions that exercised control over the people? <br/> How did they exercise
          this control? <br/>
          2. Who was Sor Juana Ines De La Cruz? <br/> Why is she example of how patriarchy shaped Latin American
          lives? <br/>
          3. What is transculturaliztion? <br/> What are some examples of this? <br/>
          ...
          14. Who led the second peasant revolt? <br/> When did it start? <br/> Why was unsuccessful? <br/>
          ...
          <p>Answer the following questions: <br/>
            ...
            7. What are some conflicts which occurred within emerging nations? <br/> What was the effect on the
            ...
            15. Who was Matthew Perry? <br/> When did he arrive? <br/> What did he want? <br/>
            ...
            22. Who benefits from public education? <br/> Why should people like to pay taxes for public education
            even if they don’t have a kid in public education? <br/>
            23. What did Nationalism mean in Japan? <br/>
            24. What did the Meiji Government do to benefit Japan? <br/> What was the dark side of the Meiji
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            6. How might a realist novel bring about changes in society? Describe the ways by which this might happen.
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/14_TheBeginningsofIndustrialization.pdf")}
                     rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            the greatest invention of the Industrial Revolution? <br/> Why? <br/>
          </p>
          <textarea className="textArea" onChange={onChangeSS7Listener31} value={SS7Essay31}/>

          <span className="days">LESSON 32</span>
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/15_Industrialization.pdf")} rel="noreferrer"
          ...
          questions: <br/>
          <br/>What do we have today thanks to the Industrial Revolution according to John Green? <br/> (Name
          Five.)
          ...
          15. How did India cotton push Europe into the Industrial Revolution? <br/></p>
          ...
          <p>Do you believe that Industrialization was a good or bad thing? <br/>
          ...
          <p>Click here for a 5 Paragraph Essay OUTLINE if you need help in getting started. <br/></p>
          ...
          3. What were Joint Stock Companies? <br/> How did they increase wealth? <br/>
          4. What is Industrial Capitalism according to Joyce Appleby? <br/>
          5. What are the downsides of capitalism? <br/>
          6. Where did Industrial Capitalism begin? <br/> When? <br/> Why? <br/>
          ...
          9. What was the result of increased productivity in agriculture? <br/> What was the effect of
          industry? <br/>
          10. What was enclosure? <br/> What was the result of enclosure on tenant farmers? <br/>
          ...
          14. What were some problems of capitalism in the 19th century? <br/> What was the response of workers
          ...
          22. What is Class Struggle according to Karl Marx? <br/> Who was the class struggle between according
          to Karl Marx? <br/>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/20_WarandExpansion.pdf")} rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            that rose at the end of the 19th century similar to mass culture today? <br/> How is it
            different? <br/> Explain your response. <br/>
          ...
          10. How many people died? <br/> How many were wounded? <br/>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/32_EuropePlungesintoWar_TheGreatWar.pdf")}
                     rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. Why might it be fair to say that
            neither side won the battles of the Somme or Verdun? <br/>
            3. Which countries made up the
            Central Powers? <br/> Which
            countries comprised the Allies? <br/>
            4. What were the characteristics
            of trench warfare? <br/>
            5. What factors contributed to
            Russia’s war difficulties? <br/>
            6. How was war on the
            Western and Eastern Fronts different? <br/> How was it the
            same? <br/>
          ...
          <Video videoUrl="https://www.youtube.com/embed/IIiDULrXaqQ"/>     <p>Answer the following
          questions: <br/>
          Write a brief summary of the video. Consider what the main points were and interesting aspects that
          John Greene discussed. 5-6 sentences. <br/></p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. Which of the non-European
            countries had the greatest impact on the war effort? <br/>
            Explain.
            3. What factors helped prompt
            the United States to join the
            war for the Allies? <br/>
            ...
            7. Do you think governments are
            justified in censoring war news? Why or why not? <br/></p>
          <textarea className="textArea" onChange={onChangeSS7Listener57} value={SS7Essay57}/>

          <span className="days">LESSON 58</span>
          <p>In a 5 Paragraph Essay, identify and discuss the three most significant factors leading to the
            outbreak of World War I. In addition to using the readings and videos, you may do online research to
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. Was the United States right to
            reject the Treaty of Versailles? Why or why not? <br/>
            3. What was the goal of Woodrow
            Wilson’s Fourteen Points? <br/>
            4. What was the "war guilt" clause
            in the Treaty of Versailles? <br/>
            5. Why did the United States
            reject the Treaty of Versailles? <br/>
            6. Were the Versailles treaties fair? <br/>
            Consider all the nations affected.
            7. Why might the European Allies have
            been more interested in punishing Germany than in
            creating a lasting peace? <br/></p>
          ...
          <p>Write a brief summary of the video. Consider what the main points were and interesting aspects that
            John Greene discussed. 5-6 sentences. <br/></p>
          ...
          <p> Next, answer the following questions:<br/>
            ...
            you think is it important?)<br/>
            5. After your jet lands, how will you get to this place? (Ex. I will take a cab. It’s 30 minutes
            from the airport." OR "I will need to get a GPS and trek 3 days into the jungle to find it." OR "a mountain
          ...
          <Video videoUrl="https://www.youtube.com/embed/U6KR4cLLVzQ"/>     <p>Answer the following
          questions: <br/>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/36_Totalitarianism.pdf")} rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            plans the best way to move the Soviet economy forward? <br/>
            Explain.
          ...
          4. What does the Republic of China call Sun Yat-Sen? <br/> What does the People’s
          ...
          20. What was the Soviet Model? <br/> How did it effect China? <br/>
          21. Explain the Great Leap Forward.
          22. How did China pay the USSR for heavy machinery? <br/> What was the effect on
          the Chinese? <br/>
          23. Describe the Cultural Revolution.
          24. What were the "Four Olds"? <br/> What happened to those that representing
          them? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            <li>a. American market for European goods Dropped</li>
            <li>b. unemployment rates soared</li>
            <li>c. European banks and businesses closed</li>
          </p>
          ...
          <Video videoUrl="https://www.youtube.com/embed/Ojo8-GhhQcA"/>     <p>Answer the following
          questions: <br/>
          Write a summary of the video highlighting the main points that John Greene discussed. 5-6
          sentences. <br/></p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. What emotions did both Hitler and
            Mussolini stir in their followers? <br/>
            ...
            fall to dictators? <br/>
            6. Why did a movement like
            fascism and leaders like Mussolini and Hitler come to
            power during a period of crisis? <br/>
            7. Why do you think Hitler had
            German children join Nazi organizations? <br/></p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. Why weren’t the Czechs invited
            to take part in the Munich Conference? <br/>
            ...
            6. What similar goals did Hitler, Mussolini,
            and Hirohito share? <br/>
            7. Do you think the Fascist nations of
            the Axis Powers could have been stopped? Explain. <br/></p>
          <textarea className="textArea" onChange={onChangeSS7Listener73} value={SS7Essay73}/>

          <span className="days">LESSON 76</span>
          <p>Until the U.S. was attacked at Pearl Harbor, the U.S. was reluctant to enter the war. What is
            your opinion about the U.S. policy of isolationism during the 1930s and waiting so long to assist
            the Allies in World War II? <br/></p>
          <p>Write a 5 Paragraph Essay on this topic. After you formulate your opinion, create an
            outline that includes your thesis and three supporting points. Click here for an OUTLINE that
            can help you get started. You may need to do some research online. <br/></p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            <p>Answer the following questions: <br/>
              ...
              6. What do you think is meant by the statement that Winston Churchill possibly was Britain’s most powerful
            ...
            <p> After you complete the reading, answer the following questions:<br/>
              ...
              7. Why do you think the Japanese changed their approach from trying to win the support of the colonized
            ...
            <p> After you complete the reading, answer the following questions:<br/>
              ...
              7. Why do you think the German people went along with the Nazi policy of persecution of the Jews? <br/>
            </p>
            <textarea className="textArea" onChange={onChangeSS7Listener77} value={SS7Essay77}/>

            <span className="days">LESSON 80</span>
            <p>Watch the video below: <b>The Holocaust,Genocides, and Mass Murder of WWII</b> by Crash Course European
              History </p>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/46_TheAlliedVictory.pdf")} rel="noreferrer"
          ...
          29. How many Indians died in the war? <br/> Vietnamese? <br/> Americans? <br/> Germany and Japan
          non-combatants? Russians? <br/>
          30. What was used to slaughter millions? <br/></p>
          ...
          people. What were some things they did to rebuild themselves which allowed them to become a superpower? <br/>
          ...
          3. Describe how Berlin became a divided city.
          4. What did the Soviet Union do to punish people wo were not loyal communists? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. What circumstances prevented
            Mao’s Great Leap Forward from bringing economic
            prosperity to China 3. How did the Chinese
            Communists increase their
            power during World War II? <br/>
            4. What actions did the
            Nationalists take during World
            War II? <br/>
            5. What was the goal of the
            Cultural Revolution? <br/>
            6. Why did the United States support
            the Nationalists in the civil war in China? <br/>
            7. What policies or actions enabled the
          ...
          <p>Answer the following
            ...
            17. Give 2 examples of how he did this.
            18. When did the Berlin Wall come down? <br/></p>
          ...
          <p> Next, answer the following questions:<br/>
            ...
            you think is it important?)<br/>
            5. After your jet lands, how will you get to this place? (Ex. I will take a cab. It’s 30 minutes
            from the airport." OR "I will need to get a GPS and trek 3 days into the jungle to find it." OR
            "A mountain bike is the best mode of transportation."<br/>
            6. Where will you stay and for how long? (Ex. I will stay in a hut on the beach for 3 months OR
            …in a treehouse in the jungle for the weekend OR …in a rented camper so I can tour the area for 6
            months.<br/>
            7. What language do they speak?<br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            Kenya? <br/> What was their goal? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            Transcaucasian Republics? <br/> the
            ...
            mean by this reference? <br/> Do you agree with it? <br/>
          ...
          questions: <br/>
          1. List examples of Empires that ended before the 20th century.
          2. What makes the recent decolonization different from previous revolutions? <br/>
          ...
          Africa? <br/> Discuss an example of this? <br/>
          ...
          <p>Watch the video below: <b> Middle East geopolitics explained simply || The Middle East
            explained in a nutshell</b></p>
          <Video videoUrl="https://www.youtube.com/embed/BpTDDKsdMcY"/>
          <p>Write a brief summary of the video. Discuss the main points and include what you considered to
            be the most interesting aspects. 5-6 sentences. <br/></p>
          ...
          <p>Write a <i>5 Paragraph Essay</i> discussing the Palestinian-Israeli Conflict and which group
            you side with. You may need to do some research online. Be sure to site specific examples to
            explain your position. Click here for an OUTLINE that can help you get started with the
            essay. </p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            6. What role did the policy of containment play in the involvement of the United States in wars in Korea and
            Vietnam? <br/>
          ...
          <p>Watch the video below: <b> Vietnam </b> by Crash Course</p>
          <Video videoUrl="https://www.youtube.com/embed/Gk1rRqeTEOY"/>
          <p>Write a brief summary of the video. Discuss the main points and include what you considered
            to be the most interesting aspects. You may need to watch the video twice and take notes while watching. 5-6
            sentences. <br/></p>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/51_ChangesinCentralandEasternEurope.pdf")}
                     rel="noreferrer"
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/52_TheColdWarThaws.pdf")} rel="noreferrer"
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            6. In view of Soviet policies toward Eastern Europe in the postwar era, what reasons did people in Eastern
          ...
          <p>Answer the following questions: <br/>
            ...
            4. Democracy is about protecting the best interests of the people. What are some of these interests? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            7. What have been some of the obstacles to democracy in Latin America? <br/></p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            6. Why do you think that space exploration became an arena for cooperation between the Soviet Union and the
            United States? <br/>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            8. How can individuals affect social conditions around the world? Consider the example of Mother Teresa when
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            5. What steps did the United States take in response to the terrorist attacks of September 11, 2001? <br/>
          ...
          <Video videoUrl="https://youtu.be/nlsnnhn3VWE"/>
          <p>Write a brief summary of the video. Discuss the main points and include what you considered to be the most
            interesting aspects. You may need to watch the video twice and take notes while watching. 5-6
            sentences. <br/>
          </p>
          ...
          <p> After you complete the reading, answer the following questions:<br/>
            ...
            2. "Ethnocentrism—the belief in the superiority of one’s own ethnic group—has taken hold in the world." Do
            you
            ...
            7. Do you think that limiting the amount of foreign television programming is an effective way to protect
          ...
          <p>Answer the following questions: <br/>
            ...
            6. What is John Green biased against? <br/> Why? <br/>
            7. What effect did individualism have on sex and family? <br/>
            8. What are some effects of globalization on the environment? <br/>
            9. Who is the Open Letter addressed to? <br/>
            10. What is in the Secret Compartment? <br/>
            11. What do we use more of as worldwide consumption increases? What are the consequences of this use? <br/>
            ...
            16. List examples in which economic success is not dependent on democracy.
            17. What consequences (good and bad) can potentially be caused by globalization? <br/>
          ...
          <p>Watch the video below: <b> Democracy, Authoritarian Capitalism, and China </b>by Crash Course World History
          </p>
          ...
          <p>Answer the following questions: <br/>
            ...
            4. Give a drawback of an authoritarian capitalism.
            5. What is the advantage of the Chinese-style meritocracy? <br/>
            ...
            11. Do you think China's authoritarian capitalism must be followed by other countries? <br/> Why? <br/>
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/63_Worldreligionsandethicalsystems1.pdf")}
                     rel="noreferrer"
          ...
          <p>Read <a href={require("../resources/social-studies/ss-pdfs7th/63_Worldreligionsandethicalsystems2.pdf")}
                     rel="noreferrer"
          ...
          ‎ <p>Watch the video below: <b> 2,000 Years of Chinese History! The Mandate of Heaven and Confucius </b> by
          Crash Course</p>
          ...
          <p> This next segment will focus on learning about the geography of South America. Note: If you prefer to
            ...
            After watching a short video about a country, you will be asked to answer several questions based on what
            you
            learned. Read the questions ahead of time as it will help you take notes while watching the videos.</p>
          <p className="regions">South America</p>
          ...
          <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it? What is the meaning behind
            ...
            8. Your <a href="https://tapmap.simpledzn.com" rel="noreferrer" target="_blank">Tap Map </a>score for today.
          </p>
          ...
          <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it? What is the meaning behind
            the colors and/or the design? If the flag is not research it online.<br/>
            2. What language do they speak? If they speak more than one, list them all.<br/>
            3. Would you ever want to live there? Why or why not.<br/>
            4. Did you learn anything about their history, economy or government? If so,
            explain.<br/>
          ...
          <p className="regions"> Central & Western Asia</p>
          ...
          <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it? What is the meaning behind
            ...
            6. Describe what you learned about the land and physical geography. <br/>
            7. List three things about the country you found to be very interesting or surprising.<br/>
            8. Your <a href="https://tapmap.simpledzn.com" rel="noreferrer" target="_blank">Tap Map </a>Asia score for
            today.</p>
          ...
          <p>Watch the video below about<b> Georgia</b> by Geography Now. Then answer the questions that follow. </p>
          ...
          <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it?
            What is the meaning behind the colors and/or the design? If the flag is not discussed in the video, research
            it online.<br/>
            2. What language do they speak? If they speak more than one, list them all.<br/>
            3. Would you ever want to live there? Why or why not.<br/>
            4. Did you learn anything about their history, economy or government? If so,
          ...
          <p>- After you finish the questions above, go to <a href="https://tapmap.simpledzn.com">Tap Map</a> to
            ...
            - Practice for 20 minutes. <a href="timer20" rel="noreferrer" target="_blank">Set a 20
              minute timer. </a><br/>
          ...
          <p>Watch the video below about<b> Kazakhstan</b> by Geography Now. Then answer the questions that follow. </p>
          ...
          <p>Watch the video below about<b> Kyrgyzstan</b> by Geography Now. Then answer the questions that follow. </p>
          ...
          <p>Watch the video below about<b> Pakistan</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Saudi Arabia</b> by Geography Now. Then answer the questions that follow.
          </p>
          ...
          <p>It's time to travel again anywhere in the world. Where will you go this time?<br/>
            Milford Sound in New Zealand? <br/>Zhangye Danxia Geopark, China? <br/>Venice, Italy? <br/>Banff National
            Park, Canada? <br/>Great Ocean Road, Australia?
          </p>
          If you have no idea where to you'd like to go, get inspired by <a
          href="https://www.lifehack.org/articles/lifestyle/17-stunning-places-visit-with-google-maps.html"
          target="_blank"> this site about stunning places</a> or this video showing some of the most beautiful places
          in
          the world.<br/>
          <Video videoUrl="https://www.youtube.com/embed/vwZBiG1_IWs"/>
          <p> Next, answer the following questions:<br/>
            ...
            is it important?)<br/>
            5. After your jet lands, how will you get to this place? (Ex. I will take a cab. It’s 30
            minutes from the airport." OR "I will need to get a GPS and trek 3 days into the jungle to find it."
            OR "A
            mountain bike is the best mode of transportation."<br/>
            6. Where will you stay and for how long? (Ex. I will stay in a hut on the beach for 3 months OR
            …in a treehouse in the jungle for the weekend OR …in a rented camper so I can tour the area for 6
          ...
          <p className="regions"> East and South Asia</p>
          ...
          <p>Watch the video below about<b> East Timor</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Indonesia</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> North Korea</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the videos below about<b> South Korea</b> by Geography Now. Then answer the questions that follow.
          </p>
          ...
          <p>Watch the video below about<b> Maldives</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Mongolia</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Philippines</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Australia</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Kiribati</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>Watch the video below about<b> Micronesia</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p> 1.
            ...
            colors and/or the design? If the flag is not research it online.<br/>
            2. What language do they speak? If they speak more than one, list them all.<br/>
            3. Would you ever want to live there? Why or why not.<br/>
            4. Did you learn anything about their history, economy or government? If so, explain.<br/>
            5. List a few ways that this country is different than where you live.<br/>
          ...
          <p>Watch the videos below about<b> New Zealand</b> by Geography Now. Then answer the questions that follow.
          </p>
          ...
          <p>Watch the videos below about<b> Solomon</b> by Geography Now. Then answer the questions that follow.</p>
          ...
          <p>It's time to travel one last time anywhere in the world. Where will you go?<br/>
          ...
          <p> Next, answer the following questions:<br/>
            ...
            8. What things/activities will you do when you get there?<br/>
            <br/></p>
          <textarea className="textArea" onChange={onChangeSS7Listener182} value={SS7Essay182}/>
        </div>
      </div>
    </form>
  )
