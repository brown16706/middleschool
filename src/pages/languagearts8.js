        ...
        <form>
          <section className="section raise-top">
            <div className="section-content">
              ...
              <Img style={{ maxWidth: "60%" }} fluid={data.theAlchemist.childImageSharp.fluid}
                   alt="The Alchemist novel"/><br/>
              ...
              <p className="margin-para"><a
                ...
                <Img fluid={data.bookthief.childImageSharp.fluid} alt="The Book Thief novel"/></a></p>
              ...
              <Img fluid={data.giver.childImageSharp.fluid} alt="The Giver novel"/><br/>
              ...
              <p>Read Chapter 20 of <i>The Giver.</i><br/>
                ...
                3. <i> The Giver</i>didn’t see beyond; he heard beyond. What was he able to hear that no one else could?<br/>
              ...
              <p>Thinking about the themes: The Giver<br/>
                ...
                3. When you read the final rule in his instructions, "You may lie," how did you feel about this? If you
                ...
                4. What are the good and bad things about Jonas’s family?<br/>
                5. There are groups in the United States today that actively seek to maintain an identity outside the
              ...
              <p> Thinking about the success of<i> The Giver </i><br/>
                1. Do you think that <i> The Giver </i>seems like an award-winning book?<br/>
              ...
              <p> Create a new book cover for The Giver. <br/>
                ...
                viewers a glimpse of the content and mood of the book. You can use whatever medium you choose: collage,
                paper and markers, or <a href="https://www.canva.com/create/book-covers/" rel='noreferrer'
                                         target="_blank"> Canva’s online book cover creation tool. </a>You choose how
                you want to design it. Your cover should include:
                1. A clear title and the author’s name. <br/>
              ...
              <Img className="margin-para" fluid={data.poetry.childImageSharp.fluid} alt=""/>
              ...
              <p> What makes a poem a poem is its ability to make the reader feel something. It may rhyme, but doesn’t
                have to. Using few words, it creates a picture in the reader's mind and transports them to another place
                and time. </p>
              ...
              <ol className="vocab">
                ...
                <li> Find an example from a novel or short story that reads like poetry. What makes it sound poetic?
                </li>
              </ol>
              ...
              to our gait: rhythm is central to our experience, and often brings us pleasure. We can find pleasure in
              the rhythm of a song, or even the rows of an orchard. Of course, too much repetition can also backfire.
              David Silverstein describes what poetic repetition is and why it works.</p>
              ...
              <ol className="vocab">
                ...
                <li> Can you find a visual representation of repetition in your world? Maybe repeated rows of desks? Or
                  roads lined with trees? How might you capture that repetition in language, so someone might visualize
                  the patterns without physically seeing them?
                </li>
              </ol>
              <textarea className="textArea" onChange={onChangela8Listener140} value={la8Essay140}/>

              <span className="days">LESSON 141 </span>
              <h4>The art of the metaphor</h4> <p>How do metaphors help us better understand the world? And, what makes
              ...
              <Img className="smaller-img" fluid={data.fog.childImageSharp.fluid}
              ...
              <ol className="vocab">
                ...
                <li> How would you describe the mother in Langston Hughes' poem "Mother to Son"? What kind of life has
                  she had?
                </li>
              ...
              <Img className="smaller-img" fluid={data.wildgeese.childImageSharp.fluid} alt="Wild Geese poem"/><br/>
              <Video videoUrl="https://www.youtube.com/embed/zIEXGgQi3T8"/>
              <ol className="vocab">
                <li className="poem"><i>Based on the video "Become a slam poet in five steps":</i> What is the yellow
                  paper Tyler is writing about?
                </li>
                ...
                <p>In Mary Oliver's poem <i>Wild Geese,</i> the poet demonstrates her understanding of people needing a
                  sense of purpose. She also understands how many people feel like they are an outsider. In simple
                  words, she encourages her readers to
                  look to nature for answers to life's questions. </p>
              ...
              <p> Along with writing some of most famous quotes in literature, Shakespeare’s insults, put-downs, and
              ...
              <ol className="vocab">
                ...
                <h4>Based on the video <i>A Long and Difficult Journey, or The Odyssey: Crash Course Literature</i></h4>
              ...
              <ol className="vocab">
                ...
                <li><i>Based on the poem Ocean of Earth: What is the imagery in the poem? </i></li>
              ...
              <Img fluid={data.apollinaire.childImageSharp.fluid} alt="apollinaire"/><br/>
              ...
              <p>Robert Frost was an American poet known for his poems about life in New England’s countryside. When his
              ...
              <p>After graduating high school, he briefly attended Dartmouth College but quit to pursue becoming a poet.
              ...
              <ol className="vocab">
                <li><h4>Based on the poem <i>If </i>by Rudyard Kipling: </h4> Why is Kipling’s poem titled "If"?</li>
              ...
              <p>Excerpts taken from the SPL Poetry Handbook <br/>
                Slow down. Read it slowly. A good poet will have made every word in the poem count. Step into the poem
                and wander around. Take your time. <br/>
                See where the encounter takes you. <br/>
                You might not like the poem. It might do nothing for you. Don’t feel under any pressure to like every
                poem you meet. You won’t. <br/>
                Relax. Hmmm… the poem has got you intrigued? But you don’t understand it. Not to worry. Poems aren’t
                crossword puzzles. There’s no correct answer. A good poem will offer many paths to meander along.</p>
              ...
              <p>The following exercise is from Steve Bowkett’s <i>Countdown to Poetry.</i> Take a few moments to study
                the image below.</p>
              <Img fluid={data.bwimage1.childImageSharp.fluid} alt="black and white image"/><br/>
              <ol className="vocab">
              ...
              <Img fluid={data.hope.childImageSharp.fluid} alt="Hope poem"/><br/><br/>
              {/*<ul>*/}
              ...
              <Img fluid={data.imNobody.childImageSharp.fluid} alt=""/><br/><br/>
              ...
              <Img fluid={data.figTree.childImageSharp.fluid} alt="woman blended with a tree"/><br/>
              ...
              <p> After you watch the video, complete the lists below. Then, use the lists to write
                your Self-Portrait Poem below.</p>
              ...
              <p><i>Cirque Du Freak</i> is the frightening saga of a young boy whose visit to a mysterious freak show
                leads him on a journey into a dark world of vampires. Filled with grotesque creatures, murderous
                ...
                or can be purchased online. Until you get a copy, the <a
                  ...
                  target="_blank"> reading for the first lesson is posted here</a> as a PDF.</p>
              <Img fluid={data.cirqueDuFreak.childImageSharp.fluid} alt="Cirque Du Freak novel"/>
              <div className="topBottom">Read Chapters 1, 2 and 3 of <i> Cirque Du Freak.</i> Then, answer the
                questions and complete the vocabulary assignment
                below. Be sure to use complete sentences.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 4, 5, and 6 of <i> Cirque Du Freak.</i> Be sure to use complete
              ...
              <div className="topBottom">Read Chapters 7, 8, and 9 of <i> Cirque Du Freak.</i> Be sure to use complete
                sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 13 and 14 of <i> Cirque Du Freak.</i> Be sure to use complete
                sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 15, 16 and 17 of <i> Cirque Du Freak.</i> Be sure to use
                complete sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 18 and 19 of <i> Cirque Du Freak.</i> Be sure to use complete
                sentences in your work below.
                <ol className="vocab">
                  ...
                  <li> Why can’t Darren stop himself from playing with the spider, even
                    though he recognizes the danger?
                  </li>
                  ...
                  <li> Listen to some of Mozart’s music (below) and write one paragraph describing it. Include how you
                    felt listening to it. Skip around to hear a variety of his work.
                  </li>
                </ol>
                <Video videoUrl="https://www.youtube.com/embed/Rb0UmrCXxVA"/>
              </div>
              ...
              <div className="topBottom">Read Chapters 22 and 23 of <i> Cirque Du Freak.</i> Be sure to use complete
                sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 24, 25 and 26 of <i> Cirque Du Freak.</i> Be sure to use
                complete sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 27 and 28 of <i> Cirque Du Freak.</i> Be sure to use complete
                sentences in your work below.
                <ol className="vocab">
              ...
              <div className="topBottom">Read Chapters 29,30,31,32 and 33
                of <i> Cirque Du Freak.</i> Be sure to use complete sentences in your work below.
                <ol className="vocab">
              ...
              <h4>Write a short chapter based on Cirque Du Freak</h4>
              ...
              <p>Be sure to cover the following questions in your chapter:</p>
              <ul className='assnList'>
              ...
              <p className="topBottom"><i>Answer the questions below to develop your story:</i></p>
              ...
              <p>After you watch the video <b> The power of a great introduction</b>, you will write a mystery.</p>
              ...
              <div className="rowimages">
                <div className="columnimages">
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.dog.childImageSharp.fluid}
                            alt="girl with dog"/>
                    <p className="captionTitle">By the River</p>
                    <p className="caption">When the dog beckoned for her to follow, the girl quickly jumped on her
                      bike.</p></div>
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.throwingstone.childImageSharp.fluid}
                            alt="child throwing a stone"/>
                    <p className="captionTitle">No Ordinary Day</p>
                    <p className="caption">She threw with all her might, but the stone came back and landed at her
                      feet.</p>
                  </div>
                </div>
                <div className="columnimages">
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.twokeys.childImageSharp.fluid}
                            alt="two keys"/>
                  ...
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.traintracks.childImageSharp.fluid}
                            alt="train tracks"/>
                    <p className="captionTitle">Final Destination </p>
                    <p className="caption"> He warned her not to get on the train. Now it was too late.</p>
                  </div>
                </div>
                <div className="columnimages">
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.pathinwoods.childImageSharp.fluid}
                            alt="path through the woods"/>
                    <p className="captionTitle">Off the Beaten Path</p>
                    <p className="caption">You got lost in the woods and it's getting late. Suddenly, a bright light appears.</p>
                  </div>
                  <div><Img style={{ maxWidth: "500px" }} fluid={data.maninthefog.childImageSharp.fluid}
                            alt="man walking through the fog"/>
                    <p className="captionTitle">Man in the Fog</p>
                    <p className="caption">As the man slowly walked toward your house, you heard him say, "It's
                      time." </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rowimages">
                <div className="columnimages2">
                  <Img style={{ maxWidth: "500px" }} fluid={data.balloon.childImageSharp.fluid}
                       alt="fantasy hot air balloon"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.dragon.childImageSharp.fluid}
                       alt=""/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.elephant.childImageSharp.fluid}
                       alt="Young man approaching elephant on the beach"/>
                </div>
                <div className="columnimages2">
                  <Img style={{ maxWidth: "500px" }} fluid={data.snowstatue.childImageSharp.fluid}
                       alt="A team of people walking upmountain next to enormous statue"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.greeneyes.childImageSharp.fluid}
                       alt="fantasy image of green eyes"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.wolf.childImageSharp.fluid}
              ...
              <div className="rowimages">
                <div className="columnimages">
                  <Img style={{ maxWidth: "500px" }} fluid={data.burningcity.childImageSharp.fluid}
                       alt="city in distress"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.mermaid.childImageSharp.fluid}
                       alt="underwater city"/>
                </div>
                <div className="columnimages">
                  <Img style={{ maxWidth: "500px" }} fluid={data.robot.childImageSharp.fluid}
                       alt="child robot"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.swamp.childImageSharp.fluid}
                       alt="man walking through swamp"/>
                </div>
                <div className="columnimages">
                  <Img style={{ maxWidth: "500px" }} fluid={data.train.childImageSharp.fluid}
                       alt="girl waiting for train"/>
                  <Img style={{ maxWidth: "500px" }} fluid={data.vr.childImageSharp.fluid}
              ...
              <p className="topBottom"><b>Science fiction</b>

                Science fiction includes novels like<i> Ready Player One and The Martian.</i></p>
              <p className="topBottom">Select one of the images below to based your own science fiction story on.
                Write your story in the textbox below. If you prefer to write a story not based on an image, this is
                fine as well.</p>
              <div className="rowimages">
                <div className="columnimages">
                  <Img style={{ maxWidth: "500px" }} fluid={data.burningcity.childImageSharp.fluid}
...
export const query = graphql`
{
  ...
  giver: file(relativePath: {eq: "subjects/bookCovers/giver.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  poetry: file(relativePath: {eq: "subjects/poetry.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  fog: file(relativePath: {eq: "subjects/poems/fog.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 700) {
  ...GatsbyImageSharpFluid
}
  ...
  wildgeese: file(relativePath: {eq: "subjects/poems/wildgeese.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  apollinaire: file(relativePath: {eq: "subjects/poems/apollinaire.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  bwimage1: file(relativePath: {eq: "subjects/bwimage1.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  figTree: file(relativePath: {eq: "subjects/poems/figTree.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  cirqueDuFreak: file(relativePath: {eq: "subjects/bookCovers/cirqueDuFreak.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  burningcity: file(relativePath: {eq: "subjects/stories/burningcity.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  mermaid: file(relativePath: {eq: "subjects/stories/mermaid.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  robot: file(relativePath: {eq: "subjects/stories/robot.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  swamp: file(relativePath: {eq: "subjects/stories/swamp.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  train: file(relativePath: {eq: "subjects/stories/train.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  vr: file(relativePath: {eq: "subjects/stories/vr.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  dog: file(relativePath: {eq: "subjects/stories/dog.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  pathinwoods: file(relativePath: {eq: "subjects/stories/pathinwoods.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  throwingstone: file(relativePath: {eq: "subjects/stories/throwingstone.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  twokeys: file(relativePath: {eq: "subjects/stories/twokeys.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  traintracks: file(relativePath: {eq: "subjects/stories/traintracks.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  maninthefog: file(relativePath: {eq: "subjects/stories/maninthefog.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  balloon: file(relativePath: {eq: "subjects/stories/balloon.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  dragon: file(relativePath: {eq: "subjects/stories/dragon.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  elephant: file(relativePath: {eq: "subjects/stories/elephant.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  snowstatue: file(relativePath: {eq: "subjects/stories/snowstatue.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  greeneyes: file(relativePath: {eq: "subjects/stories/greeneyes.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
  ...
  wolf: file(relativePath: {eq: "subjects/stories/wolf.jpg"}) {
  childImageSharp {
  fluid(maxWidth: 900) {
  ...GatsbyImageSharpFluid
}
