    ...
    <Layout>
      ...
      <section className="block-circles">
        <div className="subjects-circle circle1"
             style={{backgroundColor: '#f16d7b', transform: "translate3d(0px, 0px, 0px) scale(0.9921, 1)", opacity: "0.9881" }}/>
        <div className="subjects-circle circle2" style={{backgroundColor: '#f16d7b', transform: "translate(0px, 0px)", opacity: 1 }}/>
        ...
        <form>
          <section className="section raise-top">
            <div className="section-content">
              ...
              <p className="topBottom">This course will use the CK12 Earth Science textbook.  If you don't already have one, <a href="https://www.ck12.org/auth/signup/student"
                                                                       rel="noreferrer" target="_blank"> set up a free
                account with CK12. </a> Then add the <a href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-physical-science-flexbook-2.0/">CK-12
              ...
              <p>Begin the first Chapter: <a
                ...
                rel="noreferrer" target="_blank"> 1.1 Nature of Science </a></p>
              <p className="lessons">Complete the reading, watch the videos and answer the 'Start Practice' questions on the
                bottom right of the ck12 website (green button).</p>
              ...
              <textarea className="textArea"
                        ...
                        onChange={onChangeSci8Listener1} value={sci8Essay1}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener4} value={sci8Essay4}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener5} value={sci8Essay5}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener6} value={sci8Essay6}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener7} value={sci8Essay7}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener8} value={sci8Essay8}/>

              <span className="days">LESSON 9 </span>
              <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-physical-science-flexbook-2.0/section/1.19/primary/lesson/hypothesis-ms-ps"
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener9} value={sci8Essay9}/>
              ...
              <textarea className="textArea" onChange={onChangeSci8Listener10} value={sci8Essay10}/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. The graph below shows the results of a scientific investigation. Researchers measured the amount of force
                (in pounds) needed to penetrate hardwoods of different species. How would you communicate the results of the
                investigation in words?<br/>
                4. Why do some scientists have difficulty communicating about their research to nonscientists?<br/>
                5. What is the role of science writers in scientific communication?<br/></p>
              <textarea className="textArea" onChange={onChangeSci8Listener12} value={sci8Essay12}/>

              <span className="days">LESSON 13 </span>
              <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-physical-science-flexbook-2.0/section/1.23/primary/lesson/replication-in-science-ms-ps"
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                centimeters?<br/>
                <img alt="metric ruler" src={require("../../content/images/subjects/1-28Figure7.jpg")}/>
                ...
                <img alt="triple beam balance" src={require("../../content/images/subjects/1-28Figure8.jpg")}/>
                3. How much liquid does this graduated cylinder contain?<br/>
                <img alt="cylinder" src={require("../../content/images/subjects/1-28Figure9.jpg")}/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. What was your score for the challenege?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Create a sketch that shows the particles of matter in two substances that differ in density. Label the
                sketch to show which substance has greater density.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. What is flammability? Identify examples of flammable matter.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Make a table to compare and contrast solutions, colloids, and suspensions. Include an example of each
                type of mixture in your table.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                5. Write your score for the challenge.</p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. Make a table comparing and contrasting solids, liquids, and gases.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Create a table comparing and contrasting crystalline and amorphous solids. Include an example of each
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Describe in words what the data in the table show.<br/>
                2. If you were to draw a line graph of temperature and viscosity, what would it look like? Make a rough
                sketch to show how it would look. (Assume that the x-axis represents temperature and the y-axis represents
                viscosity.)<br/>
                3. Write a hypothesis to explain the relationship between temperature and viscosity of water.<br/>
                4. Summarize the videos.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                high altitude instructions, like those on the label below. Explain why.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. What is the melting point of a substance? What is the melting point of ice?<br/>Refer to the table from
                this chapter to determine the conclusion you might draw about the melting points of alloys relative to the
                melting points of the metals they contain?<br/>
                4. Bronze is another alloy. It is a mixture that contains mainly copper with some added tin. The melting
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Make a table comparing and contrasting vaporization and evaporation.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                ice?<br/>
                6. How can dry ice be changed back to a gas?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Sketch a model of a beryllium atom, which has four protons, five neutrons, and four electrons. Your model
                should include the placement of electrons at the appropriate energy levels.<br/>
                4. What are valence electrons? Why are they so important? How many valence electrons does a beryllium atom
                have (see question 3)?<br/>
                5. Who discovered electrons? When were they discovered?<br/>
                6. Outline how electrons were discovered.<br/>
                7. What was the significance of the discovery of electrons?<br/>
                8. Where did Thomson think electrons were located in the atom? How does this differ from the modern view of
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Make a table comparing and contrasting the three types of fundamental particles. Include an example of
                each type in your table.<br/>
                3. Make a two- or three-dimensional model of a hydrogen atom (1 proton and 1 electron) that represents all
                of its fundamental particles, including force-carrying particles.<br/>
                4. What is the standard model? In what ways is it incomplete?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                5. List properties of ions.<br/>
                6. The model in the illustration below represents an atom of lithium (Li). If the lithium atom becomes an
                ion, which type of ion will it be, a cation or an anion? What will be the electric charge of this ion? What
                will the ion be named? What symbol will be used to represent it?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                passed since the organism died?<br/></p>
              ...
              <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-physical-science-flexbook-2.0/section/4.2/primary/lesson/modern-periodic-table-ms-ps"
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. How are ionic compounds named? Give an example.<br/> <br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Compare and contrast the properties of ionic and covalent compounds.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. What are some useful ways alloys may differ from pure metals?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. What is the concentration of a 500 mL solution that contains 5 mL of solute?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                between solutions of nitric acid (HNO3) and potassium hydroxide (KOH): HNO3 + KOH → ____ + _____<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. What distance will a truck travel in 3 hours at an average speed of 50 miles per hour?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Describe how to make a position-time graph.<br/>What is the slope of a line graph? What does the slope of
                a position-time graph represent?<br/>
                2. Can a line on a position-time graph have a negative slope, that is, can it slope downward from left to
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Define acceleration. Describe an example of acceleration and explain how velocity is changing. When a
                skydiver opens her parachute, how will her velocity change when the parachute first opens?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Write the equation for acceleration without a change in direction.<br/>What is the SI unit for
                acceleration?<br/>
                2. During the final 5 seconds of a race, a cyclist increased her velocity from 4 m/s to 7 m/s. What was her
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Identify and define the SI unit for force. Imagine kicking a soccer ball. Describe the force applied to
                the ball and how the ball will move after it is kicked.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Define friction, and explain why it occurs.<br/>Identify two factors that affect friction. Why does
                friction warm your hands when you rub them together?<br/>
                2. Outside wooden steps may get slippery when they are wet. How could you make them less slippery?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. What is a fluid? Give an original example of fluid friction.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Define orbit and orbital motion, and explain why orbital motion occurs.  In addition to the moon,
                artificial satellites also orbit Earth. What factors do you think must be taken into account to ensure that
                a satellite keeps orbiting Earth rather than falling back to Earth’s surface?<br/>
                2. Earth is closer to nearby planets including Venus and Mars than it is to the sun. Why don’t these other
                planets pull Earth toward them and cause it to veer off its orbit around the sun.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. State Newton’s first law of motion.<br/>You don’t need to push off with a foot against the ground to
                start a skateboard rolling down a bank. Does this violate Newton’s first law of motion? Why or why not?<br/>
                2. Nina ran into a rough patch of pavement, but she thought she could ride right over it. Instead, the
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. 2. How is work defined in physics?<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                advantage?<br/>
                5. Juan uses a lever to lift a rock. He places the rock on the short arm of the lever and pushes down on the
                other arm of the lever. He applies 30 N of force over a distance of 1 m. The other end of the lever moves in
                the opposite direction and raises the rock a distance of 0.2 m. What is the weight (force) of the rock?<br/>
                6. What is the mechanical advantage of the lever in question 1?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                <img alt="cylinder" src={require("../../content/images/subjects/13-1Figure1.jpg")}/>
                ...
                <img alt="cylinder" src={require("../../content/images/subjects/13-1Figure2.jpg")}/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Make a table of forms of energy. In your table, list and define five of the forms of energy described in
                this article. Include an example of each form.<br/></p>
              ...
              trampoline. Include a sketch to help explain the energy conversions.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Outline the use of energy resources in the U.S.<br/>
                2. Compare the use of oil in the U.S. with oil use in other nations.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Draw a sketch of a house in which energy is being wasted. Then explain how energy could be conserved
                instead.<br/></p>
              ...
              specific heat to explain why.<br/></p>
              ...
              <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
                <a
                  ...
                  rel="noreferrer" target="_blank">
                </a>16.2 Transverse Wave</p>
              <p className="lessons">Answer the questions below. <br/>
                1. What is a transverse wave?<br/>
                2. Sketch a transverse wave and label the crests and troughs.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Draw a sketch of a longitudinal wave. Use arrows to show the direction of the wave and the direction of
                the vibrating particles of the medium. Add labels to identify the compressions and rarefactions.<br/>
                3. Describe P waves.Describe protons.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                3. Explain how surface waves change when they reach shallow water near shore.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Create a table comparing and contrasting constructive and destructive interference.<br/>
                3. What are standing waves? How do they form?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                5. How is ultrasonography like sonar?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. Make a table comparing and contrasting three ways that luminescence can occur.<br/>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                colors, what color would you get?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                Draw a sketch as a visual aid.<br/>
              ...
              <span className="days">LESSON 165 </span>
              <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-physical-science-flexbook-2.0/section/19.9/primary/lesson/optical-instruments-ms-ps" rel="noreferrer" target="_blank"> 19.9 Optical Instruments</a></p>
              <p className="lessons">Answer the questions below. <br/>
                1.	Define optics.<br/>
                2.	Explain how a compound microscope uses convex lenses to make an enlarged image of a tiny object.<br/>
                3.	Compare and contrast reflecting and refracting telescopes.<br/>
                4.	Write a paragraph explaining how a camera works. Assume you are explaining it to a much younger student. Draw a sketch as a visual aid.<br/>
                5.	Explain how reflection is involved in the production of laser light.<br/>
                6.	How are optical fibers used?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Explain how lenses can be used to correct vision problems.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Make a simple table summarizing electric forces between charged particles.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                2. Create a sketch showing how the electric fields of two negatively charged particles interact.<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                1. Compare and contrast direct and alternating current.<br/>
              </p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                of the appliance and wires is 12 ohms, how much current is flowing through the circuit?<br/></p>
              ...
              <p className="lessons">Answer the questions below. <br/>
                ...
                4. Sketch two bar magnets that are arranged so their magnetic fields attract each other. Label the magnetic
                poles, and add arrows to represent lines of force between the two magnets.<br/></p>
