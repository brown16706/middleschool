          ...
          <div className="section raise-top">
            <div className="section-content">
              ...
              <p>Answer the following questions: <br/>
                ...
                3. Why does it make sense that the Scientific Revolution would follow the Renaissance and continue
                alongside
              ...
              <p>Take a few minutes to think about the essay topic and then create an outline for <i> which impact of
                the Enlightenment you think is most important.</i> <a href={require("../resources/FiveParagraphEssayOutline.pdf")}
                                                                      rel="noreferrer"
                ...
                arguments you are going to make. It is a road map for your essay and should answer the question, "What is this paper about?" <br/>
                ...
                point. You should include examples, explanations and support for your claims and ideas. Be sure to smoothly transition to the next paragraph. It should tie
                ...
                your statements and transition to the next paragraph. 3-5 sentences. <br/><b> Paragraph
                  3 </b><br/>&nbsp; &#8226; This should be your second strongest point. It should be different from the other
              ...
              <textarea className="textArea" placeholder="Write your 5 paragraph essay here.  Be sure to back up your work and/or send it to your parent or teacher." onChange={onChangeSS7Listener6} value={SS7Essay6}/>
              ...
              <p>Answer the following questions: <br/>
                ...
                5. Why might Africans in North America have been better off had the British won the Revolutionary
                War? <br/>
              ...
              <p> If you had lived in France during Napoleon’s rein of power, would you have supported him? <br/> In a 5
                ...
                <a href={require("../resources/FiveParagraphEssayOutline.pdf")} rel="noreferrer"
              ...
              <p> Next, answer the following questions:<br/>
                ...
                5. After your jet lands, how will you get to this place? (Examples include: <i>I will take a cab. It’s 30 minutes
                  from the airport </i>...  <i>I will need to get a GPS and trek 3 days into the jungle to find it </i>... <i>A
                  helicopter is the only way to get there.</i>) <br/>
                6. How long will you stay there and where will you stay? (Examples: I will stay <i>in a hut on the beach</i> ...
              ...
              <p>Click <a href={require("../resources/FiveParagraphEssayOutline.pdf")} rel="noreferrer"
              ...
              <p> After you complete the reading, answer the following questions:<br/>
                ...
                2. Which of the events during the last phase of czarist rule do you think was most responsible for the fall of the czar? <br/>
              ...
              <Video videoUrl="https://www.youtube.com/embed/U6KR4cLLVzQ"/>     <p> Write a summary of the video highlighting the main points that John Greene discussed. 5-6
              sentences. <br/></p>
            ...
            6. Describe two memorable things you learned from the video.<br/>
              ...
              <p>Write a 5 Paragraph Essay on this topic. After you formulate your opinion, create an
                outline that includes your thesis and three supporting points. Click <a
                  href={require("../resources/FiveParagraphEssayOutline.pdf")} rel="noreferrer"
                  target="_blank">here for an outline</a> that
              ...
              <span className="days">LESSON 76</span>
                ...
                <p>Answer the following questions: <br/>
                  ...
                  4. After Hitler’s unsuccessful attempt to overthrow the German government, what was his new strategy to seize power in Germany?<br/>
                  5. How was the result of World War I used by Hitler and the Nazis to seize power and gain support amongst the German people?<br/>
                  6. What role did the Great Depression of 1929 play in making the Nazi party a force in German politics?<br/>
                  7. The fact that the Nazis had virtually no power in the German government before the Great Depression, how did this make Hitler’s rhetoric & promises to restore Germany’s greatness more attractive to the German people?<br/>
              ...
              <span className="days">LESSON 77</span>
                ...
                <p> Next, answer the following questions:<br/>
                  ...
                  3. Why did you choose this place?<br/>
                  4. Discuss the cultural, historical or environmental significance this place has. (In what ways do you think is it important?)<br/>
                  5. After your jet lands, how will you get to this place? (Examples include: <i>I will take a cab. It’s 30 minutes
                    from the airport </i>...  <i>I will need to get a GPS and trek 3 days into the jungle to find it </i>... <i>A
                    helicopter is the only way to get there.</i>) <br/>
                  6. How long will you stay there and where will you stay? (Examples: I will stay <i>in a hut on the beach</i> ...
              ...
              <p>Write a <i>5 Paragraph Essay</i> discussing the Palestinian-Israeli Conflict and which group
                ...
                explain your position. Click <a href={require("../resources/FiveParagraphEssayOutline.pdf")}
                                                rel="noreferrer"
              ...
              <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it? What is the meaning
                ...
                6. Describe what you learned about the land and physical geography. <br/>
                7. List three things about the country you found to be very interesting or surprising.<br/>
                8. Your <a href="https://tapmap.simpledzn.com" rel="noreferrer" target="_blank">Tap Map </a>Asia score
                for
                today.</p>
              ...
              If you have no idea where to you'd like to go, get inspired by this video showing some of the most scientifically impossible 
              ...
              <p> 1. Describe the country's flag. On a scale of 1 to 10, how much do you like it? What is the meaning
                ...
                6. Describe what you learned about the land and physical geography. <br/>
                7. List three things about the country you found to be very interesting or surprising.<br/>
                8. Your <a href="https://tapmap.simpledzn.com" rel="noreferrer" target="_blank">Tap Map </a>quiz score
                for
                today from Asia Map.
              </p>
              <p><span className='smallerFont'> After you finish the questions above, set a <a
