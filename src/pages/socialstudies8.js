    ...
    <Layout>
      ...
      <section className="block-circles">
        ...
        <div className="subjects-circle circle2"
             style={{ backgroundColor: "#64ccbc", transform: "translate(0px, 0px)", opacity: 1 }}/>
        ...
        <form>
          <section className="section raise-top">
            <section className="section-content">
              ...
              <p>Watch the video below <b> The Natives and the English - by Crash Course </b></p><br/> <Video
              ...
              <p>Watch the video below <b> Effects of European Colonization: Christopher Columbus and Native
                Americans</b> by
                TedEd</p><br/> <Video videoUrl="https://www.youtube.com/embed/wsMGICONtb8"/>
              <p className="margin-para"> Answer the following questions:<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/2.1Spain'sEmpireintheAmericas.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Spain's Empire in the Americas</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/2.2AnEnglishSettlementatJamestown.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> An English Settlement at Jamestown</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/2.3PuritanNewEngland.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Puritan New England</i></a></p>
              <p>Watch the video below <b> The Quakers, the Dutch, and the Ladies by Crash Course </b></p>  <br/> <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/2.4SettlementoftheMiddleColonies.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Settlement of the Middle Colonies</i></a></p>
              <p>Watch the video below <b> When is Thanksgiving? Colonizing America by Crash Course </b></p><br/> <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/3.1EnglandandItsColonies.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> England and Its Colonies</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> mercantilism</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/3.2TheAgriculturalSouth.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Agricultural South</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/3.3TheCommercialNorth.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Commercial North</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance. <br/>
                <ol className="ssList">
                  <li> Enlightenment</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/3.4TheFrenchandIndianWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The French and Indian War</i></a></p>
              <p>Watch the video below <b> The Seven Years War and the Great Awakening by Crash Course </b></p><br/>
              <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/4.1TheStirringsofRebellion.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Stirrings of Rebellion</i></a></p>
              <p>Watch the video below <b> Taxes & Smuggling - Prelude to Revolution by Crash Course </b></p><br/>
              <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/4.2IdeasHelpStartaRevolution.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Ideas Help Start a Revolution</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TheDeclarationofIndependence.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Declaration of Independence</i></a></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/4.3StrugglingTowardSaratoga.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Struggling Toward Saratoga</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Valley Forge</li>
              ...
              <p>Watch the video below <b> Who Won the American Revolution? by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/5.1ExperimentingwithConfederation.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Experimenting with Confederation</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/GeographySpotlightTheLandOrdinanceof1785.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> Geography Spotlight: The Land Ordinance of
                1785</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
             ...
             https://www.lifehack.org/articles/lifestyle/17-stunning-places-visit-with-google-maps.html"
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/5.2DraftingtheConstitution.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Drafting the Constitution</i></a></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/5.3RatifyingtheConstitution.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Ratifying the ConstitutionThe Living Constitution</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Federalist</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TheLivingConstitution.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i>
              ...
              <p>Watch the video below <b> The Making of the American Constitution </b></p><br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/6.1WashingtonHeadstheNewGovernment.pdf")}
                    rel="noreferrer" target="_blank">Click here to read
                <i> Projects for Citizenship: Applying the Constitution - Washington Heads the New Government</i></a>
              </p>
              <p>Watch the video below <b> Where US Politics Came From by Crash Course </b></p><br/><Video
              ...
              <p>Watch the video below <b> Thomas Jefferson & His Democracy by Crash Course </b></p><br/><Video
              ...
              <p>Watch the video below <b> The War of 1812 - by Crash Course </b></p><br/><Video
              ...
              <p>Watch the video below <b> Age of Jackson by Crash Course </b></p><br/><Video
              ...
              <p>Watch the video below <b> 19th Century Reforms by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/8.2SlaveryandAbolition.pdf")} rel="noreferrer"
                    target="_blank">Click here to read<i> Slavery and Abolition</i></a></p>
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                American? <br/> 6.
                Why do you think that many of the people who fought for abolition also fought for women’s rights?<br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/8.4TheChangingWorkplace.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Changing Workplace</i></a></p>
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                hazards?<br/>
                6. Describe the two waves of U.S. immigration in the mid-1800s. <br/></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/9.2ManifestDestiny.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Manifest Destiny</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/GeographySpotlightMappingtheOregonTrail.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Geography Spotlight: Mapping the Oregon
                Trail</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                destiny as meaning that American settlers should possess the "whole of the continent" that "Providence"
                has
                given us for the development of the great experiment of liberty and . . . self- government." Do you
                think
                the same attitudes exist today? Explain.<br/>
                3. Why was the concept of manifest destiny of particular appeal to Americans in the 1840s? <br/> 4. What
                were the factors that drew settlers west during the first half of the 19th century? <br/>
                4. Compare the motivations of travelers on the Oregon, Santa Fe, and Mormon trails. Which do you think
                was the
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/9.3ExpansioninTexas.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Expansion in Texas</i></a></p>
              <p>Watch the video below <b> War & Expansion by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/9.4TheWarwithMexico.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The War with Mexico</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> James K. Polk</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/10.1TheDivisivePoiticsofSlavery.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The Divisive Politics of Slavery</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                3. What were the major terms of the Compromise of 1850?<br/> 4. Do you think there are any points at
                which a
                different action or leader might have resolved the conflict between the North and the South?<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/10.2Protest,Resistance,andViolence.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Protest Resistance and Violence</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/10.3TheBirthoftheRepublicanParty.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The Birth of the Republican Party</i></a>
              </p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TracingThemesStatesRights.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read<i> Tracing Themes: States' Rights</i></a></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/10.4SlaveryandSecession.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Slavery and Secession</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TheSupremeCourtDredScottv.Sandford.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The Supreme Court: Dred Scott v. Sandford
                (1857)</i></a></p>
              <p>Watch the video below <b> How one piece of legislation divided a nation</b></p><br/>
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                3. If you had been voting in the presidential election of 1860, for whom would you have voted, other
                than
                Abraham Lincoln? <br/>
                4. In Dred Scott v. Sandford of 1857, the Supreme Court found that: 'A free negro of the African race,
                whose
                ancestors were brought to this country and sold as slaves, is not a "citizen" within the meaning of the
                Constitution of the United States. ' How did the Supreme Court decision add to the tensions over slavery
                in
                the 1850s?<br/> 5. Compare and contrast Abraham Lincoln’s and Stephen A. Douglas’s views about slavery
                in
                the territories. <br/>
              ...
              <p><b> 5 Paragraph Essay</b><br/> In your own words, define three different causes of the Civil War. After
                providing a discussion of each of
                these causes, describe how they might or might not have interacted with each other. <br/>Do you think
                each
                ...
                started.
                You may need to do some research online. This step will save you from having to rewrite your essay after
                you
                start.
                ...
                point. You should include examples, explanations and support for your claims and ideas. Be sure to
                smoothly transition to the next paragraph. It should tie
                ...
                thoughtful conclusion. 3-5 sentences. <br/> The video below is also helpful in how to write a solid
                essay.
              ...
              <p>Watch the video below <b> Battles of the Civil War by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                2. What were the military strategies of the North and South at
                the outset of the Civil War?<br/>
                3. What advantages did the North have over the South?<br/>
                4. What if Virginia had not seceded from the Union in 1861? Speculate on how this might have affected
                the
                course of the war. <br/>
                5. What do you think were General McClellan’s major tactical errors?<br/>6. Do you think Lincoln’s
                decision
                to fire McClellan was a good one? Why or why not?<br/></p>
              ...
              <p>Watch the video below <b> The Civil War, Part I by Crash Course </b></p><br/><Video
              ...
              <p>Watch the video below <b> The Civil War Part 2 by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                Why?<br/>
                3. o you think that a general’s win- loss record on the battlefield is the best gauge of measuring
                greatness
                as a military leader? Why or why not? <br/>
                ...
                5. In what ways did the South’s morale deteriorate? <br/> 6. What was Grant and Sherman’s rationale for
                using the strategy of total war?<br/> 7. Why do you think Lincoln urged generous terms for a Confederate
                surrender? <br/>
              </p>
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                government do to help the South?<br/> 4. What political and social issues from the Civil War era do you
                think are still issues today?<br/> 5. What might have happened if the North had allowed the South to
                secede?<br/> 6.
                Could the Civil War have been avoided? <br/> 7. Did the eventual result of the war justify its
                cost?<br/>
              </p>
              ...
              <p>Watch the video below <b> Reconstruction and 1876 by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/13.1CulturesClashonthePrairie.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Cultures Clash on the Prairie</i></a></p>
              ...
              <p>Watch the video below <b> Gold Rush by the History Channel </b></p><br/> <Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                Native Americans? <br/>
                5. What economic problems confronted American farmers in the 1890s? <br/> 6. According to farmers and
                other
                supporters of free silver, how would bimetallism help the economy<br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/14.1TheExpansionofIndustry.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Expansion of Industry</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/GeographySpotlightIndustryChangestheEnvironment.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> Geography Spotlight: Industry Changes the
                Environment</i></a></p>
              <p>Watch the video below <b> The Industrial Economy by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                2. Do you think that consumers gained
                power as industry expanded in the
                late 19th century? Why or why not?<br/>
                3. If the U.S. had been poor in
                natural resources, how would
                industrialization have been
                affected?<br/>
                4. Which invention or development
                described in this section had the
                greatest impact on society?<br/>
                5. How did the growth of the steel industry influence the
                development of other industries?<br/>
                6. How did inventions and developments in the late 19th
                century change the way people worked?<br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/14.2TheAgeofRailroads.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Age of Railroads</i></a></p>
              <p>Watch the video below <b> Westward Expansion by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                2. Do you think the government and private citizens could have done more to curb the corruption and
                power of
                the railroads?<br/>
                3. Why did people, particularly farmers, demand regulation of the railroads in the late 19th
                century? <br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/14.3BigBusinessandLabor.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Big Business and Labor</i></a></p>
              <p>Watch the video below <b> Why do Americans and Canadians celebrate Labor Day?</b> by Kenneth C. Davis
              </p>

              <br/> <Video videoUrl="https://www.youtube.com/embed/YqmPE2HtkyU"/>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                2. Do you think that the tycoons of the late 19th century are best describe as ruthless robber barons or
                as
                effective captains of industry?<br/>
                3. Does the life of Andrew Carnegie
                support or counter the philosophy
                of Social Darwinism? <br/>
                4. If the government had supported
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/15.1TheNewImmigrants.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The New Immigrants</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Ellis Island</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/15.2TheChallengesofUrbanization.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The Challenges of Urbanization</i></a></p>
              <p>Watch the video below <b> Growth, Cities, and Immigration by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/15.3PoliticsintheGuildedAge.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Politics in the Guilded Age</i></a></p>
              <p>Watch the video below <b> Gilded Age Politics by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/16.1ScienceandUrbanLife.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Science and Urban Life</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/16.2ExpandingPublicEducation.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Expanding Public Education</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/16.3SegregationandDiscrimination.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Segregation and Discrimination</i></a></p>
              <p><a
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/16.4TheDawnofMassCulture.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Dawn of Mass Culture</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/17.1TheOriginsofProgressivism.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The Origins of Progressivism</i></a></p>
              <p>Watch the video below <b> The Progressive Era by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/17.2WomeninPublicLife.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Women in Public Life</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> NACW</li>
                ...
                submissive and nonpolitical?<br/> 3. Why do you think some colleges refused to accept women in the late
                19th
                century?<br/> 4. Imagine you are a woman during the Progressive Era. Explain how you might recruit other
                women to support the following causes: improving education, housing reform, food and drug laws, the
                right to
                vote.<br/> 5. Give two examples of national women’s organizations committed to social activism. Briefly
                describe their progressive missions. <br/> 6. In the late 1890s, what job opportunities were available
                to
                uneducated women without industrial skills? <br/></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/17.3TeddyRoosevelt'sSquareDeal.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Teddy Roosevelt's Square Deal</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/AmericanLiteratureTheMuckrakers.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> American Literature: The Muckrakers</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/17.4ProgressivismUnderTaft.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Progressivism Under Taft</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                the
                future of progressive reforms.<br/>
                6. Both Roosevelt and Taft resorted to mudslinging during the 1912 presidential campaign. Do you approve
                or
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/17.5Wilson'sNewFreedom.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Wilson's New Freedom</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/18.1ImperialismandAmerica.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Imperialism and America</i></a></p>
              <p>Watch the video below <b> American Imperialism by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                following passage, how does Indiana Senator Albert J. Beveridge explain the need for the U.S. to acquire
                new
                territories? 'Fate has written our policy for us; the trade of the world must and shall be ours. We will
                establish trading posts throughout the world as distributing points for American products. Great
                colonies
                governing themselves, flying our flag and trading with us, will grow about our posts of trade.'<br/> 4.
                In
                your opinion, did Sanford B. Dole and other American planters have the right to stage a revolt in Hawaii
                in
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/18.2TheSpanish-AmericanWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Spanish-American War</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> José Martí</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/18.3AcquiringNewLands.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Acquiring New Lands</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Foraker Act</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/18.4AmericaasaWorldPower.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> America as a World Power</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/GeographySpotlightThePanamaCanal-AFunnelforTrade.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> Geography Spotlight: The Panama Canal - A Funnel
                for
                Trade</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                ...
                7. In your opinion, should the United States have become involved in the affairs of Colombia, Nicaragua,
                and
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/19.1WorldWarIBegins.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> World War I Begins</i></a></p>
              <p>Watch the video below <b> America in World War I by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/19.2AmericanPowerTipstheBalance.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> American Power Tips the Balance</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/19.3TheWaratHome.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The War at Home</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/HistoricDecisionsoftheSupremeCourt.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Historic Decisions of the Supreme Court:
                Schenck
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/19.4WilsonFightsforPeace.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Wilson Fights for Peace</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TracingThemesAmericainWorldAffairs.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Tracing Themes: America in World Affairs</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/20.1AmericansStrugglewithPostwarIssues.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Americans Struggle with Postwar
                Issues</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/20.2TheHardingPresidency.pdf")}
                    rel="noreferrer"
                    target="_blank"> Click here to read <i> The Harding Presidency </i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/20.3TheBusinessofAmerica.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Business of America</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TracingThemesEconomicOpportunities.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Tracing Themes: Economic
                Opportunities</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/21.1ChangingWaysofLife.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Changing Ways of Life</i></a></p>
              <p>Watch the video below <b> The Roaring 20's by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/21.2TheTwentiesWoman.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Twenties Woman</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/DailyLifeYouthintheRoaringTwenties.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Daily Life: Youth in the Roaring
                Twenties</i></a></p>
              <p>Watch the video below <b> The fight for the right to vote in the United States</b></p><br/><Video
              videoUrl="https://www.youtube.com/embed/P9VdyPbbzlI"/>
              <p>Watch the video below <b> Women's Suffrage by Crash Course </b></p><br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/21.3EducationandPopularCulture.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Education and Popular Culture</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/21.4TheHarlemRenaissance.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Harlem Renaissance</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/AmericanLiteratureLiteratureintheJazzAge.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> American Literature: Literature in the Jazz
                Age</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a
                ...
                rel="noreferrer" target="_blank">Click here to read <i> Hardship and Suffering During the Depression</i></a>
              </p>
              <p>Watch the video below <b> The Great Depression by Crash Course </b></p><br/><Video
              videoUrl="https://www.youtube.com/embed/VfOR1XCMf7A?list=PL8dPuuaLjXtMwmepBjTSG593eG7ObzO7s"/>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/22.3HooverStruggleswiththeDepression.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Hoover Struggles with the Depression</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/23.1ANewDealFightstheDepression.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> A New Deal Fights the Depression</i></a></p>
              <p>Watch the video below <b> The New Deal by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/23.3TheNewDealAffectsManyGroups.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The New Deal Affects Many Groups</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/23.4Cultureinthe1930s.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Culture in the 1930s</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/23.5TheImpactoftheNewDeal.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Impact of the New Deal</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/24.1DictatorsThreatenWorldPeace.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Dictators Threaten World Peace</i></a></p>
              <p>Watch the video below <b> World War II Part 1 by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/24.2WarinEurope.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> War in Europe</i></a></p>
              <p>Watch the video below <b> World War II Part 2 - The Homefront by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                6. To what extent do you think lies and deception played a role in Hitler’s tactics? <br/>
                7. Review Germany’s aggressive actions between 1938 and 1945. At what point do you think Hitler
                concluded
                that he could take any territory without being stopped? Why? <br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/24.3TheHolocaust.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Holocaust</i></a></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/24.4AmericaMovesTowardsWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> America Moves Towards War</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Axis powers</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/25.1MobilizingforDefense.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Mobilizing for Defense</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/25.2TheWarforEuropeandNorthAfrica.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The War for Europe and North Africa</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  Dwight D. Eisenhower <li></li>
                  <li> D-Day</li>
                  <li> Omar Bradley</li>
                  <li> George Patton</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/25.3TheWarinthePacific.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The War in the Pacific</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TracingThemesScienceandTechnology.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Tracing Themes: Science and
                Technology</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/25.4TheHomeFront.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Home Front</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p className="margin-para">5 Paragraph Essay<br/>
                World World II led to tremendous destruction and suffering for millions of people. What were the three
                worst
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/26.1OriginsoftheColdWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Origins of the Cold War</i></a></p>
              <p>Watch the video below <b> The Cold War by Crash Course </b></p><br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/26.2TheColdWarHeatsUp.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Cold War Heats Up</i></a></p>
              <p>Watch the video below <b> The Cold War in Asia by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/26.3TheColdWaratHome.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Cold War at Home</i></a></p>
              <p>Watch the video below <b> The Cold War - OverSimplified (Part 1) </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/26.4TwoNationsLiveontheEdge.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Two Nations Live on the Edge</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/AmericanLiteratureScienceFictionReflectsColdWarFears.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> American Literature: Science Fiction Reflects
                Cold
                War Fears</i></a></p>
              <p>Watch the video below <b> The Cold War - OverSimplified (Part 2) </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                3. List Cold War trouble spots in Iran, Guatemala, Egypt, and Hungary. For each, briefly summarize the
                U.S.
                ...
                5. Which of the two superpowers do you think contributed more to Cold War tensions during the
                1950s? <br/>
                6. Should one nation have the right to remove another nation’s head of government from power? If so,
                when?
                If
                not, why? <br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/27.1PostwarAmerica.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Postwar America</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> GI Bill of Rights</li>
                ...
                2. Do you think Eisenhower’s actions reflected his philosophy of dynamic conservatism? Why or why
                not? <br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/27.2TheAmericanDreamintheFifties.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The American Dream in the Fifties</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/27.3PopularCulture.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> Popular Culture</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/DailyLife1950-1960TheEmergenceoftheTeenager.pdf")}
                rel="noreferrer" target="_blank">Click here to read <i> Daily Life 1950-1960: The Emergence of the
                Teenager</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/27.4TheOtherAmerica.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Other America</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> urban renewal</li>
                ...
                5. How did Native Americans work to increase their participation in the U.S. political process? Which
                major
                population shift— 'white flight, ' migration from Mexico, or relocation of Native Americans—do you think
                had
                the greatest impact on U.S. society? Why? <br/>
                5. Do you think that urban renewal was an effective approach to the housing problem in inner cities? Why
                or
                why not?<br/>
                5. Do you agree or disagree with the following quotation from Life magazine on American culture in 1954:
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/28.1KennedyandtheColdWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Kennedy and the Cold War</i></a></p>
              <p>Watch the video below <b> The history of the Cuban Missile Crisis by Matthew A. Jordan </b></p><br/>
              <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/28.2TheNewFrontier.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The New Frontier</i></a></p>
              <p className=" margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className=" ssList">
                  <li> New Frontier</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/28.3TheGreatSociety.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> The Great Society</i></a></p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/29.1TakingonCivilRights.pdf")}
                    rel="noreferrer"
                    target="
               _blank">Click here to read <i> Taking on Civil Rights</i></a></p>
              <p><a
                href={require("../resources/social-studies/ss-pdfs8th/SupremeCourtBrownv.BoardofEducationofTopeka.pdf")}
                rel="
               noreferrer" target="_blank">Click here to read <i> Historic Decisions of the Supreme Court: Brown v.
                Board of Education of Topeka (1954)</i></a></p>
              <p>Watch the video below <b> Civil Rights and the 1950s by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/29.2TheTriumphsofaCrusade.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Triumphs of a Crusade</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/29.3ChallengesandChangesintheMovement.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Challenges and Changes in the
                Movement</i></a>
              </p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/TracingThemesCivilRights.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Tracing Themes: Civil Rights</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  de facto segregation <li></li>
                ...
                3. Why did some civil rights leaders urge Stokely Carmichael to stop using the slogan 'Black
                Power'? <br/>
                4. Describe four events from the civil rights movement that were broadcast on nation- wide television
                and
                that
                ...
                Explain. <br/>
                6. . Of all of the key events of the civil rights movement, in your opinion, which event was most
                significant?
                Why? <br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/30.1MovingTowardConflict.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Moving Toward Conflict</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Ho Chi Minh</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/30.2U.S.InvolvementandEscalation.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> U.S. Involvement and Escalation</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                2. Why did so much of the American public and many in the Johnson administration support U.S. escalation
                in
                Vietnam? <br/>
                ...
                6. In a paragraph, contrast the morale of the U.S. troops with that of the Vietcong. Use examples from
                the
                reading. <br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/30.3ANationDivided.pdf")} rel="noreferrer"
                    target="_blank">Click here to read <i> A Nation Divided</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> draft</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/30.41968ATumultuousYear.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> 1968: A Tumultuous Year</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Tet offensive</li>
                ...
                2. Do you think there might have been a relationship between the violence of the Vietnam War and the
                growing
                ...
                4. What acts of violence occurred in the United States during 1968 that dramatically altered the mood of
                the
                country? <br/>
                5. <br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/30.5TheEndoftheWarandItsLegacy.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> The End of the War and Its Legacy</i></a>
              </p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/LiteratureoftheVietnamWar.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> American Literature: Literature of the Vietnam War</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                War. <br/>
                7. Why do you think so many young Americans became so vocal in their condemnation of the Vietnam
                War? <br/>
                ...
                10. In the end, do you think the United States’ withdrawal from Vietnam was a victory for the United
                States
                or
                a defeat? <br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/31.1LatinosandNativeAmericansSeekEquity.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Latinos and Native Americans Seek Equity</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                ...
                2. What strategies did both César Chávez and the UFWOC use to achieve their goals? How did they
                successfully
                apply these tactics? <br/>
                3. What were the demands of the American Indian Movement (AIM) organizers who staged 'The Trail of
                Broken
                ...
                1960s?
                What were the unique concerns of the two groups? Which group do you think had more to gain by fighting
                for
                what they wanted? <br/>
                5. How would you judge whether an activist organization was effective? <br/>
                6. In what ways did the Latino campaign for economic and social equality affect non-Latino
                Americans? <br/>
                7. Vine Deloria, Jr., said, 'When you get far enough away from the reservation, you can see it’s the
                urban
                man
                who has no identity. ' What do you think he meant by this?<br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/31.2WomenFightforEquality.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Women Fight for Equality</i></a></p>
              <p>Watch the video below <b> Sex Discrimination by Crash Course </b></p><br/> <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/31.3CultureandCounterculture.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Culture and Counterculture</i></a></p>
              <p>Watch the video below <b> The 1960s in America by Crash Course </b></p><br/> <Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/32.1TheNixonAdministration.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Nixon Administration</i></a></p>
              <p>Watch the video below <b> The Rise of Conservatism by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/32.2WatergateNixon'sDownfall.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Watergate: Nixon's Downfall</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/1968-1980TelevisionReflectsAmericanLife.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Daily Life 1968-1980: Television Reflects
                American
                Life</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/32.3TheFordandCarterYears.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> The Ford and Carter Years</i></a></p>
              <p>Watch the video below <b> Ford, Carter, and the Economic Malaise by Crash Course </b></p><br/><Video
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/32.4EnvironmentalActivism.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Environmental Activism</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
                  <li> Rachel Carson</li>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/33.1AConservativeMovementEmerges.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> A Conservative Movement Emerges</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a
                ...
                rel="noreferrer" target="_blank">Click here to read <i> Conservative Policies Under Reagan and
                Bush</i></a></p>
              <p>Watch the video below <b> The Reagan Revolution by Crash Course </b></p><br/><Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                5. Why did President Reagan and President Bush think it was important to appoint conservative justices
                to
                the
                Supreme Court? <br/>
                6. Read the following excerpt from Ronald Reagan’s speech at the 1992 Republican Convention. 'We mustn’t
                forget . . . the very different America that existed just 12 years ago; an America with 21 percent
                interest
                rates and . . . double-digit inflation; an America where mortgage payments doubled, paychecks plunged,
                and
                motorists sat in gas lines; an America whose leaders told us . . . that what we really needed was
                another
                good
                dose of government control and higher taxes.' What picture did Reagan paint of the Carter
                administration? In
                your opinion, was Reagan’s first term a success?<br/>
              </p>
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/33.3SocialConcernsinthe1980s.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Social Concerns in the 1980s</i></a></p>
              <p><a href={require("../resources/social-studies/ss-pdfs8th/Sunbelt,Rustbelt,Ecotopia.pdf")}
                    rel="noreferrer"
                    target="_blank">Click here to read <i> Geography Spotlight: Sunbelt Rustbelt Ecotopia</i></a></p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a href={require("../resources/social-studies/ss-pdfs8th/33.4ForeignPolicyAftertheColdWar.pdf")}
                    rel="noreferrer" target="_blank">Click here to read <i> Foreign Policy After the Cold War</i></a>
              </p>
              <p className="margin-para"> Answer the following questions:<br/>
                1. For each term or name, write a sentence explaining its significance.<br/>
                <ol className="ssList">
              ...
              <p><a
                ...
                rel="noreferrer" target="_blank">Click here to read <i> President George H.W. Bush </i></a></p>
              <p>Watch the video below <b> George HW Bush and the End of the Cold War by Crash Course </b></p><br/>
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                result”. <br/> 2.Describe “the foreign-policy crisis that Bush handled decisively”. <br/> 3.Describe 3
                New Deal-style bills that were passed by the Democratically controlled Congress. <br/> 4.What were the 3
                possible causes of the recession that began in 1990s? <br/> 5.What probably destroyed Bush’s reelection
                hopes, AND what’s his famous quote? <br/> 6. Who were the 3 candidates in the 1992 election? <br/>
              </p>
              ...
              <p><a
                ...
                rel="noreferrer" target="_blank">Click here to read <i> President William J. Clinton</i></a></p>
              <p>Watch the video below <b> The Clinton Years and the 1990s by Crash Course </b></p><br/> <Video
              ...
              <p className="margin-para"> Answer the following questions:<br/>
                ...
                8. How did wealth disparity increase during the 90’s?<br/> Give stats.
                9. Where did the immigrants come from that were entering the US in the 90’s.
                10. How was the prison population changed in the 90’s.
              ...
              <p>Complete the reading, watch the video belows and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/user:zxbpc2rzcziwmthaz21hawwuy29t/cbook/episd-2019-2020-us-history/section/11.4/primary/lesson/president-george-w.-bush"
                  rel="noreferrer" target="_blank"> President George W. Bush. </a></p>
              <p>Watch the video below <b> Terrorism, War, and Bush 43 by Crash Course </b></p><br/> <Video
              ...
              <p>Complete the reading, watch the video belows and answer the 'Start Practice' questions for
                <a href="https://flexbooks.ck12.org/user:zxbpc2rzcziwmthaz21hawwuy29t/cbook/episd-2019-2020-us-history/section/11.5/primary/lesson/president-barack-obama"
                  rel="noreferrer" target="_blank"> President Barack Obama</a></p>
              <p>Watch the video below <b> Obamanation by Crash Course </b></p><br/> <Video
              ...
              <p>In a 5 paragraph essay, compare Joe Biden with another U.S. president of your choice. This will be
                similar to essays you’ve already written, but in this one you will need to identify and describe
                similarities
                and differences between Biden and the other president you choose. The similarities and differences can
                include anything you
                choose. For example, you can cover similarities and differences regarding their foreign policies,
                position on
              ...
              <p>It's time to travel again anywhere in the world. Where will you go this time?<br/>
                Denali National Park in Alaska? <br/>Wat Tum Sua Temple in Krabi, Thailand? <br/>Alligator Swamps in
                Florida? <br/> Mt. Fuji in Japan?
              </p>
              If you have no idea where to you'd like to go, get inspired by this video showing some of the most
              beautiful places in the world.<br/>
              ...
              <p>Watch the video below <b> Inventing the American presidency  </b>by Kenneth C. Davis. Then answer the questions that follow. </p> <br/> 
             ...
             <p> 1.	Where and when was the Constitution written?<br/>
              ...
              8.	Under the Constitution, the president is now limited to two terms. Should we go back to the original plan of unlimited terms? Why or why not?<br/> 
             </p>
              <textarea className="textArea" onChange={onChangeSS8Listener142} value={SS8Essay142}/>

              <span className="days">LESSON 143</span>              
              <p>Watch the video below <b> How is power divided in the United States government? </b> by Belinda Stutzman. Then, answer the questions that follow. </p><br/>
              <Video videoUrl="https://www.youtube.com/embed/HuFR5XBYLfU"/>
            <p> 1.	In the late 1700's, who did the Founding Fathers not want ruling the United States?
              2.	Which branch of government is described in Article I of the Constitution?
              3.	Which branch of the government commands the US military?
              4.	Who determines if federal laws are constitutional?
              5.	Besides voting, in what ways can a citizen participate in his/her government?
            </p>
            ...
            <p>Watch the video below <b> How Geography Gave the US Power. </b> Then, complete the essay assignment below.</p><br/>
            <Video videoUrl="https://www.youtube.com/embed/e-WO-c9xHms"/>  
            <p>What were the most important ways geography gave the U.S. power? Address this question in a 5 paragraph essay.</p>
            ...
            <p>It's time to travel again anywhere in the world. Where will you go this time?<br/>
              Milford Sound in New Zealand? <br/>Zhangye Danxia Geopark, China? <br/>Venice, Italy? <br/>Banff
              National Park, Canada? <br/>Great Ocean Road, Australia?
            </p>
            If you have no idea where to you'd like to go, get inspired by this video showing some of the most
            ...
            <p> Next, answer the following questions:<br/>
              ...
              <p>Let's travel one last time someplace amazing in the world. Where will you go?<br/>
                The Taj Mahal, Agra, India? <br/>The Amazon Rainforest, Brazil? <br/>Santorini,
                Greece? <br/>Bora Bora, French Polynesia? <br/>Edinburgh castle in Scotland?
              </p>
              If you have no idea where to you'd like to go, get inspired by this video showing some of the most
              beautiful
