    ...
    <Layout>
      ...
      <section className="block-circles">
        ...
        <div className="subjects-circle circle2"
             style={{ backgroundColor: "#fc7e7e", transform: "translate(0px, 0px)", opacity: 1 }}/>
        <div className="hero-wrapper pbn hero">
          <h1 className="hero intro" data-sal="slide-up"
              data-sal-duration="2000" data-sal-easing="ease">Earth Science</h1>

          <div className="hero info-block info-block-line" data-sal="slide-up"
               data-sal-duration="2000" data-sal-easing="ease"
      ...
      <form>
        <section className="section raise-top">
          <div className="section-content">
            <h1 className="section-title" data-sal="slide-up" data-sal-duration="1000"
                data-sal-easing="ease">Daily Lessons</h1>

            <span className="days" data-sal="slide-up" data-sal-delay="2000"
                  data-sal-easing="ease">LESSON 1</span>
            <p className="lessons" data-sal="slide-up" data-sal-delay="2000"
               data-sal-easing="ease">If you don't already have one, <a href="https://www.ck12.org/auth/signup/student"
                                                                     rel="noreferrer" target="_blank"> set up a free
              account with CK-12. </a> Then add the <a
              href="https://flexbooks.ck12.org/cbook/ck-12-middle-school-earth-science-flexbook-2.0/">CK-12
              Earth Science for Middle School text to your library</a> by clicking on the Start button, then Add to
              Library.
            </p>
            <p  data-sal="slide-up" data-sal-delay="2000"
                data-sal-easing="ease">Begin the first Chapter: The Nature of Science <a
              ...
              rel="noreferrer" target="_blank"> 1.1 Scientific Explanations and Interpretations. </a></p>
            <p className="lessons"  data-sal="slide-up" data-sal-duration="1000"
               data-sal-easing="ease">On the CK-12 website, complete the reading, watch the videos and answer the 'Start
              Practice' questions on the bottom right
              (green button).</p>
            <p className="lessons" data-sal="slide-up" data-sal-delay="2000"
               data-sal-easing="ease">Next, answer the questions below. <br/>
            ...
            <textarea data-sal="slide-up" data-sal-delay="2000"
                      data-sal-easing="ease" className="textArea"  placeholder="Write your responses here. Your work will automatically be saved to your Local Storage. If you clear your cookies, your answers will be erased. Be sure to save your work in another location! You can a) right click to 'Select All', right click to 'Print' and then save as a PDF on your computer, b) click to 'Share' and email to your parent/teacher, c) copy/paste into Google docs or onto your device."
                      onChange={onChangeSci7Listener1} value={sci7Essay1}/>

            <span className="days" data-sal="slide-up" data-sal-delay="2000"
                  data-sal-easing="ease">LESSON 2</span>
            <p data-sal="slide-up" data-sal-duration="1000"
               data-sal-easing="ease">Complete the reading, watch the videos, and do the 'Start Practice' exercise (bottom right) for
              <a
            ...
            <p className="lessons" data-sal="slide-up" data-sal-delay="2000"
               data-sal-easing="ease"> Answer the questions below.<br/>
            ...
            <textarea className="textArea" placeholder="When you finish, be sure to save your work!"
                      onChange={onChangeSci7Listener2} value={sci7Essay2}/>
            ...
            <textarea className="textArea" placeholder="Save your work!" onChange={onChangeSci7Listener3}
                      value={sci7Essay3}/>
            ...
            <textarea className="textArea" placeholder="Save your work!" onChange={onChangeSci7Listener4}
                      value={sci7Essay4}/>
            ...
            <textarea className="textArea" placeholder="Save your work!" onChange={onChangeSci7Listener6}
                      value={sci7Essay6}/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              4. What do geologists
              study?<br/> Oceanographers?<br/> Meteorologists?<br/> Climatologists?<br/> Environmental
              scientists?<br/> Astronomers?<br/> <br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              2. Where are the arid lands in the western United States?<br/> Why are arid lands important for
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              2. Why do most maps begin with a portion of Earth's surface?<br/> When might they use something different
              as their base?<br/>
              ...
              8. What are aerial photographs?<br/> Why does a geologist use two of the same photographs side by
              side?<br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              4. How is making a map of Earth like trying to flatten an orange peel?<br/> What problems occur when
              making a map of Earth?<br/>
              5. What is the choice you need to make when you create or use a map of the world?<br/>
              6. In a Mercator Projection, what is accurate and what isn’t?<br/> What was a Mercator map made to be able
              to do?<br/>
              7. In Lambert’s Cylindrical Projection, where is the distortion greatest?<br/> What is good?<br/> What is
              distorted?<br/>
            ...
            <p>Complete the reading, watch the videos and answer the 'Start Practice' questions for
              <a
                ...
                rel="noreferrer" target="_blank"> 3.6 Coriolis Effect </a>
            </p>
            <p className="lessons">Answer the questions below. <br/>
              1. What is the Coriolis effect?<br/>
              2. How does the Coriolis effect explain the curved flight paths in the image below?<br/>
              <img style={{ height: "200px" }} src="../../content/images/subjects/flight-path.PNG" alt="flight path"/><br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              8. What did scientists learn after the war?<br/></p>          <textarea className="textArea" onChange={onChangeSci7Listener39} value={sci7Essay39}/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. What is residence time?<br/> What does it mean to say the residence time of water in the atmosphere is
              nine days?<br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. What is difficult about plants trying to survive in a Mediterranean climate?<br/> How do they do
              that?<br/></p>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              6. What did the early plants add to the atmosphere and why was that important?<br/> What else did they
              create?<br/>
              ...
              16. What happens when shell building organisms die?<br/> What happens if those organisms are buried
              deeply?<br/>
              17. How much carbon is wrapped up in fossil fuels compared to the total amount of carbon?<br/>
              18. Where does the carbon dioxide go that is released from fossil fuels?<br/> Where does the excess carbon
              dioxide go?<br/></p>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              8. Which greenhouse gases are at their highest levels in history?<br/> When was the last time they were as
              high?<br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              1. Why is a treaty between nations needed so that we can reduce greenhouse gas emissions?<br/> Why is
              there a problem getting a treaty that will work?<br/>
              2. How does a cap-and-trade system work?<br/> Could it work for cities or businesses in the same way it
              does for nations?<br/>
              3. What is carbon sequestration?<br/> Does it prevent carbon dioxide from being emitted?<br/> Does it keep
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              2. Where do we find the oldest crust we can find?<br/> Is this what is left of the first crust?<br/> How
              do we know?<br/>
              3. What are supercontinents?<br/> How do we know of their existence (think back to the concepts in the
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              2. How do plate tectonics processes explain the Rocky Mountains?<br/> The San Andreas Fault?<br/> The
              Himalayas?<br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              that each has for successful living.
              2. Study the organisms in the photos above. For the stoats and the crowned crane, list the features that
              each has for successful living.
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. What happens if the birth rate in a population is more than the death rate?<br/> What happens if it is
              less?<br/></p>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. Looking at the graph above: When did the human population start to really grow?<br/> When did it really
              take off?<br/>
...
" rel="noreferrer" target="_blank"> 17.9 Agriculture and Human Population Growth </a>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              2. What is carrying capacity?<br/> Has the human population exceeded Earth's carrying capacity for humans?<br/> If
              so, how could this have happened?<br/>
              3. What is the Green Revolution?<br/> How has it affected human population?<br/>
              4. What do you think of Thomas Malthus' prediction?<br/> Have we proven Malthus wrong or have we just not
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              7. What is happening to Total Fertility Rate in Africa?<br/> Why does that affect the future prediction of
              population?<br/>
              8. How could the average woman give birth to 0.8 children in her lifetime in Singapore?<br/> (What is 0.8
              child?<br/>)
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              4. Why does the population graph level out and then decline a bit?<br/> Is that pattern certain?<br/> What
              is it based on?<br/>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. What role do decomposers play in an ecosystem?<br/> What would happen if there were no
              decomposers?<br/></p>
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              ancestor?<br/> How was that resolved?<br/>
              11. When was the last common ancestor between chimps and humans?<br/> When was the last between
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              12. Where does energy go?<br/> How is it created?<br/> What happens to energy?<br/> What is the universe
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              3. Why would the energy needed to make a type of energy useful increase or decrease?<br/> In other words,
            ...
            <p className="lessons">Answer the questions below. <br/>
              ...
              5. What are some of the sources of renewable energy that we could use?<br/> How much of our electricity do
            ...
            <p className="lessons">Answer the questions below. <br/>
              1. What separates surface from underground mining?<br/> Which technique do you think is more
              expensive?<br/> More dangerous?<br/>
