                ...
                <form>
                  ...
                  <p className="margin-para">If you don't already have one, <a
                    ...
                    Then, complete at least 50% of <a
                      ...
                      rel="noreferrer" target="_blank"> Intro to adding negative numbers </a> After you complete the
                    assignments for each lesson, check the Complete box above. </p>

                  {/*<span className="puzzleTitle">Solve the Math Puzzle: </span>*/}
                  {/*<p className="puzzleMargin"> Ten 7th grade students submitted 35 interesting math problems of their own.*/}
                  {/*Among the participants, there was at least one person who submitted one*/}
                  {/*problem, at least one who submitted two, and at least one submitted three.*/}
                  {/*The most entries have been submitted by Danielle. What is the smallest*/}
                  {/*possible number of problems she could have submitted?</p>*/}
                  {/*<MathPuzzle*/}
                  {/*solution="5"/>*/}
                  ...
                  <p className="puzzleMargin"> Ten red socks and ten blue socks are all mixed up in
                    a dreer drawer. The twenty socks are exactly alike
                    except for their color. The room is in pitch darkne
...
third is sure to match one of the other two."/>
                  ...
                  <p className="puzzleMargin"> Danielle wanted her mother to give her an allowance of $1.00
                    a week, but his mother refused to go higher than 50
                    cents. After they had argued about it for a while, Al
                    ...
                    Tomorrow, give me two pennies. The day after tomor-
                    row, give me four pennies. Each day, give me twice as
                    ...
                    to pay Danielle during the month of April?  Do you think the amount is closer to:<br/> $1<br/> $10<br/>  $100<br/>  $1,000<br/>  $10,000<br/>  $100,000<br/>  $1,000,000<br/>  $10,000,000</p>
                  <MathPuzzle
...
payments.  Mom's total payment to Danielle after doubling her allowance each day is $10,737,418.24."/>
                  ...
                  <p><b> Can you solve the passcode riddle?</b> by Ganesh
                    Pai </p>
                  <Video
                    videoUrl="https://www.youtube.com/embed/7Vd1dTBVbFg"/>
                  ...
                  <Video
                    videoUrl="https://www.youtube.com/embed/tbkiYideS-4"/>
                  ...
                  <p className="days"> Get ready for 8th grade</p>
