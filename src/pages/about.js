        ...
        <div style={{ minHeight: "100vh", width: "100vw", "--bubble2": "rgba(59, 181, 207, .36)" }}
          ...
          <section className={styles.sectioncontent}>
            ...
            <div className={styles.about}>
              ...
              <p className={styles.leftmarg} data-sal="slide-up" data-sal-duration="1600">b) On most Apple devices,
                'Select All' in the textbox and then select 'Share' to email to a parent or teacher.</p>
              <p className={styles.leftmarg} data-sal="slide-up" data-sal-duration="1600">c) On most devices, <i>--
                'Select
                All' (ctrl a) -- Copy (ctrl c) -- Paste (ctrl p) </i> into a Google or Word document (or another
                application like Notes/Keep). Then save it.</p>
