  ...
  return (
    ...
    <Layout>
      ...
      <>
        ...
        <section className="section math-section raise-top">
          <div className="section-content">
            <form>
              <p className='margin-para'>Set up a free account <a href="https://www.chesskid.com/register/user-type"
                                                                  rel="noreferrer" target="_blank"> at
                ChessKid.com. </a> If you already have one, you can <a href="https://www.chesskid.com/login"
                                                                       rel="noreferrer" target="_blank"> log in
                here. None of the assignments below will require a paid subscription. </a></p>
              ...
              <p className="margin-para">Play your <a href="https://www.chess.com/play/computer"
                                                      rel="noreferrer"
                                                      target="_blank"> first game </a>against a chess bot on Chess.com!
                (Instructions
                below).
                <ul className='assnList'>
                  <li>Play for twenty minutes. <a href="timer20" rel="noreferrer" target="_blank"> Set a 20 minute
              ...
              <p><a href="https://www.chesskid.com/login"
                    rel="noreferrer" target="_blank">Log in to ChessKid.</a> Then complete the lesson<a href='https://www.chesskid.com/lessons/review-topic/11e74f97362dcfca98797d2e40bc354f' rel='noreferrer' target='_blank'> Meet the Rook! (Topics 1-5) </a> Within Chess Kid you can navigate to
              ...
              <p><a href="https://www.chesskid.com/login" rel="noreferrer" target="_blank">Log in to ChessKid.</a> Then
                complete the lesson <a href='https://www.chesskid.com/lessons/review-topic/11e755e2503e526c96c6a86292af6749' rel='noreferrer' target="_blank"> Meet the Bishop (Topics 1-5) </a>
                <ul className='assnList'>
              ...
              <ul className='assnList'>
                <li>Complete the lesson <a href='https://www.chesskid.com/lessons/review-topic/11e75b4e0bd2d44c808aa44f9422f131'
              ...
              <ul className='assnList'>
                <li>Complete the lesson <a href='https://www.chesskid.com/lessons/attempt-topic/11e764d1102ad74cba80fc0f9edb2515'
                  rel='noreferrer' target="_blank"> Meet the King (Topics 1-5) </a></li>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/nowhere-to-hide-checkmate-with-king-and-2-rooks-against-king'
                ...
                <li className="margin-para">Set a <a href='timer20' rel='noreferrer' target='_blank'> 20
                  minute timer </a>and <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play with the chess bot.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Complete the lesson <a href='https://www.chesskid.com/lessons/view/meet-the-pawn' rel='noreferrer' target='_blank'> Meet the Pawn (Topics 1-5) </a></li>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/chesskid-curriculum-lesson-4---the-basic-mates' rel='noreferrer' target='_blank'> The Basic Mates </a></li>
                <li className="margin-para">Set a <a href='timer20' rel='noreferrer' target='_blank'> 20
                  minute timer </a>and <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play with the chess bot.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Complete the lesson <a href='https://www.chesskid.com/lessons/view/meet-the-knight' rel='noreferrer' target="_blank">Meet the Knight (Topics 1-5) </a></li>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/he-shouldve-castled-early-on---part-12' rel='noreferrer' target='_blank'> He Should Have Castled Early On </a></li>
                <li>Knowing chessboard coordinates is an important skill. <a href='https://www.chesskid.com/vision'
                  ...
                  <a href='https://www.chesskid.com/vision' rel='noreferrer' target='_blank'>Begin Coordinates Practice
              ...
              <ul className='assnList'>
                ...
                <li>We will begin using a free chess site called <a href='https://lichess.org/signup'>Lichess.org. </a>
                  <a href='https://lichess.org/signup'>Sign up here </a> and be sure to enable Kid Mode. There is no fee
                  or paid subscription.
                </li>
                <li>Complete the 5 lessons from <a href="https://lichess.org/learn#/7">Capture</a> on Lichess.</li>
                <li>Your <a href='https://lichess.org/training/coordinate' rel='noreferrer' target='_blank'> Coordinates
                  Practice </a>will no longer show the coordinates written on the chess board like the one below (a-h,
                  1-8). IMPORTANT:
                  Before you start, select the direction of the board using the orange button. Selecting the white king
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/when-we-were-chess-kids-learning-the-hard-way' rel='noreferrer' target='_blank'> Learning the Hard Way </a></li>
                <li>Go to <a href='https://lichess.org/training/coordinate' rel='noreferrer' target='_blank'> Coordinates Training </a> and see how many coordinates you can guess
                  correctly in 30 seconds! Be sure to select black, white or both, Practice at least 5 times.
                </li>
                <li className="margin-para">Set a <a href='timer20' rel='noreferrer' target='_blank'> 20
                  minute timer </a>and <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'> begin playing chess with the bot.</a> If you are up for the
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/check-the-checks' rel='noreferrer' target='_blank'> Secrets Of The Battering Ram </a></li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play
                  chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target='_blank'> set a 20 minute
                  timer here.</a></li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/player/castling' rel='noreferrer' target='_blank'> Castling </a>
                </li>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. You
                  can <a href='timer20' rel='noreferrer' target='_blank'> set a
                    20
              ...
              <ul className='assnList'>
                <li>Watch the following videos: <a href='https://www.chesskid.com/videos/the-language-of-chess-en-passant'
                  rel='noreferrer' target='_blank'> The Language of Chess: En Passant </a> and <a href='https://www.chesskid.com/videos/player/special-pawn-moves2'
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/player/stalemate' rel='noreferrer' target='_blank'> Stalemate </a></li>
              ...
              <ul className='assnList'>
                ...
                <li>Practice basic checkmates at <a href="https://lichess.org/practice/checkmates/piece-checkmates-i/BJy6fEDf/8K8FdT6P" rel='noreferrer' target='_blank'> Piece Checkmates 1 (Lessons 1-6). </a> Use the hints if you need them.
                </li>
                <li>Go to <a href='https://lichess.org/training/coordinate' rel='noreferrer' target='_blank'> Coordinates Training </a> and see how many coordinates you can guess
                  correctly in 30 seconds! Practice at least 5 times.
                </li>
              ...
              <ul className='assnList'>
                ...
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-i/fE4k21MW/9rd7XwOw'
                                rel='noreferrer' target='_blank'> Checkmate Patterns 1: Recognize the Patterns (1-5)</a>
              ...
              <ul className='assnList'>
                <li>Watch a videos <a href='https://www.chesskid.com/videos/the-fearsome-fork-1' rel='noreferrer' target='_blank'>The Fearsome Fork: What is a Fork? </a> and <a href='https://www.chesskid.com/videos/the-fearsome-fork-2' rel='noreferrer' target='_blank'>The
                ...
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-ii/8yadFPpU/UZ1np9Is'
                                rel='noreferrer' target='_blank'> Checkmate Patterns 2: Recognize the Patterns (1-6)</a>
                  <ul className='assnList2'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel=' noreferrer'
                                                     target='_blank'>play chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target="_blank"> set
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes.
                  <a href='timer20' rel='noreferrer' target='_blank'> Set a 20 minute timer here.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/language-of-chess-the-touch-move-rule' rel='noreferrer' target='_blank'>Touch-Move Rule.</a></li>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel=' noreferrer'
                                                     target='_blank'>play chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target="_blank"> set a 20 minute
                  timer here.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-devious-discovery-2-double-attack' rel='noreferrer' target='_blank'> The Devious Discovery 2: Double Attack" </a></li>
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-iii/PDkQDt6u/ygAaFQNc'
                ...
                <li className='margin-para'> Next, <a href='https://www.chess.com/play/computer' rel=' noreferrer'
                                                      target='_blank'>play chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target="_blank">
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-piercing-pin-1' rel='noreferrer' target='_blank'> The Piercing Pin: What is a Pin? </a></li>
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-iii/PDkQDt6u/IB4Pmsm6'
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20
                  minutes. <a href='timer20' rel='noreferrer' target='_blank'> Set a 20 minute timer
                    here.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-piercing-pin-2' rel='noreferrer' target='_blank'> The Piercing Pin: Who Can Make Pins? </a></li>
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-iii/PDkQDt6u/Nm3PDybQ'
                                rel='noreferrer' target='_blank'> Checkmate Patterns 3: Recognize the Patterns
                  (13-18)</a>
                  <ul className='assnList2'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel=' noreferrer'
                  ...
                  the bot</a> for 20 minutes. <a href='timer20' rel='noreferrer' target='_blank'> Set a 20
                  minute
                  timer here.</a></li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-scintillating-skewer-1-what-is-a-skewer' rel='noreferrer' target='_blank'>The Scintillating Skewer: What is a Skewer? </a></li>
                <li>Complete <a href='https://lichess.org/practice/checkmates/checkmate-patterns-iv/96Lij7wH/qr2pOlrL'
                                rel='noreferrer' target='_blank'> Checkmate Patterns 4: Recognize the Patterns (1-5)</a>
                  <ul className='assnList2'>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-scintillating-skewer-2-simple-skewers' rel='noreferrer' target='_blank'> The Scintillating Skewer 2: Simple Skewers</a></li>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel=' noreferrer'
                                                     target='_blank'>play chess with
                  the bot</a> for 20 minutes. <a href='timer20' rel='noreferrer' target='_blank'> Set a 20 minute timer
                  here.</a>
                </li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/closing-the-box-checkmate-with-king-and-rook-against-king'
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/how-to-keep-score-algebraic-notation' rel='noreferrer' target='_blank'> How To Keep Score: Algebraic Notation </a></li>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. You
                  can <a href='timer20' rel='noreferrer' target='_blank'> set
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/player/attraction' rel='noreferrer' target='_blank'>Attraction </a></li>
                <li>Go to <a href='https://lichess.org/training/coordinate' rel='noreferrer' target='_blank'> Coordinates Training </a> and see how many coordinates you can guess
                  correctly in 30 seconds! Practice at least 5 times.
                </li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. You
              ...
              <ul className='assnList'>
                ...
                <li>Watch a videos <a href='https://www.chesskid.com/videos/back-rank-checkmate-1-what-is-back-rank-checkmate'
                  rel='noreferrer' target='_blank'> What is Back Rank Checkmate?</a> and <a href='https://www.chesskid.com/videos/back-rank-checkmate-2-the-doubled-heavies' rel='noreferrer' target='_blank'> Back Rank Checkmate 2: the Doubled Heavies</a></li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play
                  chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target='_blank'> set
                  a 20 minute timer here.</a> As your playing improves, you can
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/more-king-and-pawn-endgames---part-2' rel='noreferrer' target='_blank'>More King and Pawn Endgames! - Part 2 </a></li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play
                  chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target='_blank'> set
                  a 20 minute timer here.</a> As your playing improves, you can
                  increase the difficulty level.
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/more-king-and-pawn-endgames---part-3' rel='noreferrer' target='_blank'> More King and Pawn Endgames! - Part 3 </a></li>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                  ...
                  chess with the bot</a> for 20 minutes. <a href='timer20' rel='noreferrer' target='_blank'> Set a 20
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/think-before-you-move-that-f-pawn----part-1'
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                                                     rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes.
                  <a href='timer20' rel='noreferrer' target='_blank'> Set a 20
                    minute timer here.</a> As your playing improves, you can increase
                  the difficulty level.
                </li>
              </ul>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20
                  minutes. <a href='timer20' rel='noreferrer' target='_blank'> Set a 20
                    minute timer here.</a> As your playing improves, you can increase
                  the
                  difficulty level.
                </li>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/player/simplifying' rel='noreferrer' target='_blank'>Simplifying </a></li>
              ...
              <ul className='assnList'>
                ...
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-chess-piece-who-swallowed-a-fly---part-12'
                  rel='noreferrer' target='_blank'> The Chess Piece who Swallowed a Fly </a></li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                                                     rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes.
                  <a href='timer20' rel='noreferrer' target='_blank'> Set a 20 minute timer here.</a> As your
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/the-chess-piece-who-ate-a-fly---part-2' rel='noreferrer' target='_blank'> The Chess Piece Who Swallowed a Fly, Part 2 </a></li>
              ...
              <ul className='assnList'>
                <li>Watch a video called <a href='https://www.chesskid.com/videos/player/zwischenzug' rel='noreferrer' target='_blank'> Zwischenzug </a></li>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play
                  chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target='_blank'> set a
              ...
              <ul className='assnList'>
                ...
                <li> Complete <a href='https://lichess.org/practice/intermediate-tactics/interference/g1fxVZu9/zSpQlGkf'
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/pawn-storms' rel='noreferrer' target='_blank'> Pawn Storms</a></li>
                <li> Complete <a href='https://lichess.org/practice/intermediate-tactics/interference/g1fxVZu9/BQhk3ngL'
                                 rel='noreferrer' target='_blank'> Interference : Interpose a piece to great effect
                  (5-7)</a>
                  <ul className='assnList2'>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                                                     rel='noreferrer' target='_blank'>play chess with the bot</a> for 20
                  minutes. You can <a href='timer20' rel=' noreferrer'
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/bad-bishops' rel='noreferrer' target='_blank'> Bad Bishops</a></li>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                  ...
                  20 minutes. You can <a href='timer20' rel=' noreferrer' target='_blank'> set a 20 minute timer
                    here.</a>
                </li>
              </ul>
              ...
              <li>Watch the video called <a href='https://www.chesskid.com/videos/player/prophylaxis' rel='noreferrer' target='_blank'> Prophylaxis</a></li>
              <ul className='assnList'>
              ...
              <ul className='assnList'>
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                                                     rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. You can <a href='timer20' rel=' noreferrer' target='_blank'> set a 20
                  minute
                  timer
                  here.</a></li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/opposition-part-2---advanced-king-play' rel='noreferrer' target='_blank'> Opposition: Advanced King Play</a></li>
                <li> Complete <a href='https://lichess.org/practice/pawn-endgames/7th-rank-rook-pawn/pt20yRkT/rfcRWU6x'
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/which-rook' rel='noreferrer' target='_blank'> Which Rook? </a></li>
                <li> Complete <a href='https://lichess.org/practice/pawn-endgames/7th-rank-rook-pawn/pt20yRkT/8TJF17dT'
              ...
              <ul className='assnList'>
                ...
                <li> Complete <a href='https://lichess.org/practice/pawn-endgames/7th-rank-rook-pawn/pt20yRkT/O2aEY5v3'
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/tricks-with-kings-and-pawns---part-1' rel='noreferrer' target='_blank'> Tricks with Kings and Pawns! -- Part 1 </a></li>
                <li> Complete <a href='https://lichess.org/practice/pawn-endgames/7th-rank-rook-pawn/pt20yRkT/qGAvVEjx'
                ...
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer'
                                                     rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. You can <a href='timer20' rel='noreferrer' target="_blank"> set a
                  20 minute timer here.</a></li>
              </ul>
              ...
              <ul className='assnList'>
                <li>Watch the video called <a href='https://www.chesskid.com/videos/player/tricks-with-kings-and-pawns----part-2' rel='noreferrer' target='_blank'> Tricks with Kings and Pawns! -- Part 2 </a></li>
                <li> Complete <a href='https://lichess.org/practice/pawn-endgames/7th-rank-rook-pawn/pt20yRkT/RZ73c1eu'
              ...
              <ul className='assnList'>
                <li>Play <a href="https://lichess.org/training" rel='noreferrer' target='_blank'>5 puzzles at Lichess. </a> If you sign in, you can set
              ...
              <ul className='assnList'>
                <li>Play <a href="https://lichess.org/training" rel='noreferrer' target='_blank'>5 puzzles at Lichess. </a> Set
              ...
              <ul className='assnList'>
                <li>Play <a href="https://lichess.org/training" rel='noreferrer' target='_blank'>5 puzzles at Lichess </a>and set the difficulty level to
                  your ability.
                </li>
                <li className='margin-para'>Next, <a href='https://www.chess.com/play/computer' rel='noreferrer' target='_blank'>play chess with the bot</a> for 20 minutes. <a href='timer20' rel='noreferrer' target="_blank">Set a 20 minute timer
                  here.</a></li>
     ...
     <div data-sal="slide-up" data-sal-duration="1000"
           data-sal-easing="ease"><h3 style={{textAlign: "center"}}>You are now a master chess player.<br/> <br/>Continue playing on your own to keep leveling up!</h3>
     </div>
    </Layout>              
  )
}
