        ...
        <>
          <section className="block-circles">
            <div className="subjects-circle circle1"
                 style={{
                   backgroundColor: "#80c5ce",
                   transform: "translate3d(0px, 0px, 0px) scale(0.9921, 1)",
                   opacity: "0.9881"
                 }}/>
            <div className="subjects-circle circle2"
                 style={{ backgroundColor: "#80c5ce", transform: "translate(0px, 0px)", opacity: 1 }}/>
              ...
              <div className="md-content">
                <form>
                  <p>If you don't already have one, <a
                    ...
                    and then begin the first lesson below.</p><br/>
                  ...
                  <p className="margin-para">After you watch the video below, <i> What are ratios?</i>, complete the
                    remainder of <a
                      href="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-ratios-prop-topic/intro-to-ratios/v/ratios-intro"
                      rel="noreferrer" target="_blank"> Intro to ratios</a></p>
                  <Video videoUrl="https://www.youtube.com/embed/puku5vUCOcE"/>
                  ...
                  <MathPuzzle solution="Split the balls into 3 groups with 3 balls each. Pick 2 groups and use scale to determine which group contains the heavy ball.<br/>
Once the group is determined, pick 2 balls and use the scale. If they are equal, the other ball is the heavy one."/>
                  ...
                  <MathPuzzle solution="The time is 6am.<br/>
For every 1 hour that has passed, the clock will only show 36 minutes as it will lose 24 minutes.<br/>
When the clock was showing 3am, 180 clock minutes have passed since midnight. This means that 300 (180/36 x 24 minutes + 180 minutes) real minutes have passed when the clock was showing 3am. Since the clock stopped 1 hour ago, another 60 minutes have passed. Therefore a total of 360 minutes have passed.<br/>
Since 360 minutes = 6 hours, the time is 6 hours after midnight."/>
                  ...
                  <p className="puzzleMargin">You have two jugs. One holds exactly 3 gallons and the other 5 gallons of
                    ...
                    jug? </p>
                  <MathPuzzle solution="Fill up the three-gallon jug and pour it into the five-gallon jug.<br/>
Do it again and there will be one gallon left in the three-gallon jug.<br/>
Empty the five-gallon jug and pour in the one gallon of water from the three-gallon jug.<br/>
Fill the three-gallon jug with water again and pour it into the five-gallon jug. The five-gallon jug should now contain 4 gallons of water."/>
                  ...
                  <MathPuzzle solution="It is 11⁄2. <br/>
Let “it” be x.<br/>
(1⁄3)x = (1⁄2)<br/>
x = 3⁄2<br/>"/>
...
x = 3⁄2<br/>"/>
                  ...
                  <p className="margin-para">Complete the remainder of <a
                    ...
                    expressions word problems</a></p>
                  <span className="puzzleTitle">Solve this Math Puzzle </span>
                  <p className="puzzleMargin">Your friend has 100 red marbles, 100 blue marbles and 2 jars.<br/>
                    He proposes a game. He fills the jars with the marbles, put the two jars behind his back and tell
                    you to pick one of them at random. You’ll then close your eyes, he’ll hand you the jar you picked,
                    and you’ll pick a random marble from that jar.<br/>
                    You win if the marble you pick is blue, and you lose otherwise.<br/>
                    To give you the best shot at winning, your friend gives you the two jars before the game starts and
                    says you can move the marbles around however you’d like, as long as all 200 marbles are in one of
                    the 2 jars (that is, you can’t throw any marbles away).<br/>
                    How should you move the marbles around to give yourself the best chance of picking a blue
                    marble?<br/></p>
                  <MathPuzzle solution="Put one blue marble in one jar, and put the rest of the marbles in the other jar. This will give you just about a 75% chance of picking a blue marble.<br/>
Let P(blue) = probability of picking a blue marble. Jar 1 contains 1 blue marble and Jar 2 contains 99 blue marbles and 100 red marbles.<br/>
So: P(blue) = P(jar 1) * P(blue in jar 1) + P(jar 2) * P(blue in jar 2)<br/>
P(blue) = 0.5 * 1 + 0.5 * 99/199<br/>
P(blue) = 0.748<br/>
Thus, we end up with ~75% chance of picking a blue marble."/>
                  ...
                  <MathPuzzle solution="There were 65 people to begin with.<br/>
19 people getting off the train can be represented by -19, and 17 people getting on the train as +17.<br/>
...
"/>
                  ...
                  <p className="puzzleMargin">There is an island filled with grass and trees and plants. The only
                    ...
                    The sheep cannot get away from the lion if the lion decides to eat it<br/>
                    Do not assume anything that hasn’t been stated above
                    Will that one sheep get eaten or not and why?<br/></p>
                  <MathPuzzle solution="The sheep will survive.<br/>
If there were 1 lion and 1 sheep, then the lion would simply eat the sheep. The sheep will not survive.<br/>
If there were 2 lions and 1 sheep, then no lion would eat the sheep, because if one of them would, it would surely be eaten by the other lion afterwards. The sheep will survive.<br/>
If there were 3 lions and 1 sheep, then one of the lions could safely eat the sheep, because it would turn into the scenario with 2 lions, where no one can eat the sheep. The sheep will not survive.<br/>
If there were 4 lions and 1 sheep, then no lion would eat the sheep, because it would turn into the scenario with 3 lions. The sheep will survive.<br/>
Continuing this argument, the conclusion is as follows:<br/>
If there is an even number of lions, then nothing happens and the sheep survives.<br/>
If there is an odd number of lions, then any lion could safely eat the sheep and the sheep will not survive.<br/>"/>
                  ...
                  <p className="margin-para">Complete the remainder of <a
                    ...
                    on the coordinate plane</a></p>
                  <span className="puzzleTitle">Solve this Math Puzzle </span>
                  <p className="puzzleMargin">Three professors were discussing over how long they have been teaching.
                  ...
                  <MathPuzzle solution="Andrew have been teaching for 21 years. Beyonce have been teaching for 15 years. Curt have been teaching for 7 years.<br/>
Let Andrew = A, Beyonce = B and Curt = C, then:<br/>
A + B = 36<br/>
B + C = 22<br/>
A + C = 28<br/>
From equation (2), we get: B = 22 – C<br/>
From equation (3), we get: A = 28 – C<br/>
Substitute A and B into equation (1): (28 – C) + (22 – C) = 36<br/>
Solving for C gives 7. Substitute (C = 7) into equation(2) and (3)<br/>"/>
                  ...
                  <p className="margin-para">You may have already completed some of the lessons below. Repeating them is
                    meant to further strengthen your skills in these areas before you begin the 7th grade. If you feel confident with the material, you may wish to test out of the lessons.</p>
                  ...
                  <MathPuzzle solution="It will take 2 hours to meet.<br/>
Method 1: Ignore the speed of the stream, as the bobber will be carried along at three miles per hour as will you. It takes two hours to travel fourteen miles, at a rate of seven miles per hour.<br/>
Method 2: As the bobber travels at 3 mph, it will be six miles closer to you in two hours. The distance between you and the bobber becomes 8 miles (14 – 6). In two hours you would have travelled 8 ( (7-3) x 2 ) miles.<br/>"/>
                  ...
                  <p className="puzzleMargin"> A monk has a very specific ritual for climbing up the steps to the
                    temple.<br/>
                    First he climbs up to the middle step and meditates for 1 minute. Then he climbs up 8 steps and
                    ...
                    three at a time which only takes him 9 paces.<br/>
                    How many steps are there? </p>
                  <MathPuzzle solution="There are 49 steps.<br/>
He climbs halfway, which is step 25. He hears the bird singing on step 33. He picks up the pebble on the 21st step and tosses it on the 22nd step. The remaining 27 steps are taken three at a time which is 9 paces (3 steps x 9 paces = 27 steps)."/>
                  ...
                  <MathPuzzle solution="The problem is that the question is cleverly phrased to conceal what is really going on.<br/>
Let’s locate all that money. There are two ways to think about how much money is out there to be found.The way that this question is tricky is that it combines that two ways.<br/>
The first way is this. How much money did mom and dad pay originally?<br/>
The second way is this. How much money did they end up paying?<br/>
So if it is the first way, then clearly the total we need to account for is the $100.<br/>
So let’s see what happens to that $100. The shirt costs $97, the boy keeps $1 and mom and dad get $1 back. That adds up fine.<br/>
Now let’s look at the second way. How much money did they end up paying? Well $98 dollars, and $97 of it went for the shirt and $1 to the boy. Now, that adds up too.<br/>
...
8.6 + 8.2 =  16.8.  Alec and Kiara got a total of 16.8 ounces of frozen yogurt.  Now multiply to find how much Alec and Kiara paid in all. They got 16.8 ounces of frozen yogurt, and it cost $0.50 per ounce.  16.8 x 0.5 = 8.40
 ...
 "/>
                  ...
                  <MathPuzzle solution=" 325 miles.    During each hour, the car travels 65 miles. For 5 hours it will travel     65 + 65 + 65 + 65 + 65 = 5 × 65 = 325 miles
"/>
